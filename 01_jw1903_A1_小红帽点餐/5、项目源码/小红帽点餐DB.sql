...
Source Database       : ordering_systemdb

Target Server Type    : MYSQL
Target Server Version : 50724
File Encoding         : 65001

Date: 2022-06-24 23:28:37
*/
...
CREATE TABLE `administrator` (
  ...
  `a_idnumber` varchar(255) DEFAULT NULL,
...
CREATE TABLE `business` (
  ...
  `b_pwd` varchar(255) DEFAULT NULL,
...
INSERT INTO `business` VALUES ('120', '张三', '2', '1234567');
INSERT INTO `business` VALUES ('126', '李四', '1', '1472583');
INSERT INTO `business` VALUES ('130', '脱志', '17', '1122330');
INSERT INTO `business` VALUES ('131', '王小励', '17823811297', '1234567');
...
CREATE TABLE `discount` (
  ...
  `d_couponnum` varchar(255) DEFAULT NULL,
  `u_id` int(11) DEFAULT NULL,
  `d_name` varchar(255) DEFAULT NULL,
  `d_details` varchar(255) DEFAULT NULL,
  `d_overlying` varchar(255) DEFAULT NULL,
  `d_concessionalrate` int(11) DEFAULT NULL,
  `d_value` int(11) DEFAULT NULL,
  PRIMARY KEY (`d_couponid`) USING BTREE,
  KEY `u_id` (`u_id`) USING BTREE,
  KEY `d_couponnum` (`d_couponnum`) USING BTREE,
  CONSTRAINT `discount_ibfk_1` FOREIGN KEY (`u_id`) REFERENCES `userinfo` (`u_id`)
...
INSERT INTO `discount` VALUES ('22', '23EXCCES', '99', '满减优惠券7', '满20减5', '0', '5', '52');
INSERT INTO `discount` VALUES ('23', '24EXCCES', '99', '满减优惠券5', '满10减2', '1', '10', '20');
INSERT INTO `discount` VALUES ('24', '25EXCCES', '99', '满减优惠券6', '满11减2', '1', '10', '198');
INSERT INTO `discount` VALUES ('25', '26EXCCES', '209', '满减优惠券8', '满20减11', '1', '11', '10');
...
CREATE TABLE `evaluate1` (
  ...
  `e_evaluate` varchar(255) DEFAULT NULL,
  `u_id` int(11) DEFAULT NULL,
  `g_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`e_recordid`) USING BTREE,
  KEY `g_id` (`g_id`) USING BTREE,
  KEY `u_id` (`u_id`) USING BTREE,
  CONSTRAINT `evaluate1_ibfk_1` FOREIGN KEY (`u_id`) REFERENCES `userinfo` (`u_id`),
  CONSTRAINT `evaluate1_ibfk_2` FOREIGN KEY (`g_id`) REFERENCES `goods` (`g_id`)
...
INSERT INTO `evaluate1` VALUES ('304', '好吃的一批', '99', '6');
INSERT INTO `evaluate1` VALUES ('306', '王励说有妈妈的味道', '99', '2');
INSERT INTO `evaluate1` VALUES ('307', '好', '99', '1');
...
CREATE TABLE `goods` (
  ...
  `g_dprice` decimal(8,2) DEFAULT NULL,
  `g_url` varchar(255) DEFAULT NULL,
  `g_coupon` varchar(255) DEFAULT NULL,
  `m_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`g_id`) USING BTREE,
  KEY `m_id` (`m_id`) USING BTREE,
  CONSTRAINT `goods_ibfk_1` FOREIGN KEY (`m_id`) REFERENCES `mer` (`m_id`)
...
INSERT INTO `goods` VALUES ('201', '王励秘制小憨包', '12.00', '2:00-23:00', '11.40', '1.png', '1', '33');
...
CREATE TABLE `mer` (
  ...
  `m_des` varchar(255) DEFAULT NULL,
  ...
  `m_isorder` varchar(255) DEFAULT NULL,
  `e_recordid` int(11) DEFAULT NULL,
  `b_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`m_id`) USING BTREE,
  KEY `b_id` (`b_id`) USING BTREE,
  KEY `mt_id` (`mt_id`) USING BTREE,
  CONSTRAINT `mer_ibfk_1` FOREIGN KEY (`mt_id`) REFERENCES `mertype` (`mt_id`),
  CONSTRAINT `mer_ibfk_2` FOREIGN KEY (`b_id`) REFERENCES `business` (`b_id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of mer
-- ----------------------------
INSERT INTO `mer` VALUES ('1', 'FlowerinessCafe佛洛力斯餐厅（大融城店）', '古茗期待打造一种极致日常化的喝茶体验，让每一个平凡的人，都能通过喝茶感受、享受当下，并且过得更开心，变得更好。日常化，绝不是快速与随便的。希望每一天的古茗茶饮，都能被喝出品质、细节，甚至是奇思妙想的惊喜。 每一杯古茗，都是“Have a good day!”的鼓励。', '10', '重庆市沙坪坝区大学城中路虎曾南段虎溪便民夜市A区31号门面', '13859376382', '佛洛力斯.jpg', '1', '128', '62');
INSERT INTO `mer` VALUES ('2', '布拉诺意大利餐厅（重庆时代店）', '我们的团队是一家全国连锁中西结合餐厅，24小时经营以港式粤菜为基础的中西融合菜，特聘香港融合菜大师主理，打造新派主题时尚餐厅。它专业的厨师团队，开发和研究新派融合菜，定期推出特色菜品，聘请专业艺术团队研发造型，让茉莉每一款菜品成为一件艺术品，让客人感受别样的饮食文化。\n', '22', '重庆市九龙坡区含谷镇含兴路24号', '15733552669', '加荷.jpg', '1', '211', '1');
INSERT INTO `mer` VALUES ('3', '豆花饭庄（鹅岭正街店）', '我们的团队深度开发新派精品新疆菜，涵括疆内各地特色美食、民族糕点，以弘扬传统饮食文化为已任，令您足不出户尝遍地道新疆特色菜肴！主营以新疆稀有珍品烹煮之精品佳肴，品位常新，应有尽有！', '2', '重庆市渝北区两江新区鸳鸯街道湖彩路118号光环购物公园L5层A-L5-03号', '18282273714', '奶茶4.png', '1', '57', '27');
INSERT INTO `mer` VALUES ('4', '古四老饭馆', '本店是正宗地道的香港美食品牌，自2006年成立以来一-直致力于传播原汁原味、独具特色的香港饮食文化。品牌承继传统港式茶餐厅特色，菜品丰富、口味独特。吃烧鹅，金翠河，享粵菜，可青睐。', '2', '渝中区邹容路100号重庆时代广场L6层L602', '15546704593', '家常.png', '1', '49', '24');
INSERT INTO `mer` VALUES ('5', '古镇唐门饭庄', '我们的团队深度开发新派精品新疆菜，涵括疆内各地特色美食、民族糕点，以弘扬传统饮食文化为已任，令您足不出户尝遍地道新疆特色菜肴！主营以新疆稀有珍品烹煮之精品佳肴，品位常新，应有尽有！', '13', '重庆市九龙坡区谢家湾正街55号万象城4层86号', '13512038658', '家常2.png', '1', '168', '81');
INSERT INTO `mer` VALUES ('6', '加荷港式茶餐厅（重庆财富购物中心店）', '我们的团队在这里北欧风格的后现代元素与奔放的埃及风会同重庆火锅的炽热，完美地融为一体！精致的产品、精细的服务又体现了过江龙对现代都市人消费观念的完全认同！我们完全有理由淡忘喧闹的码头传统，激情拥抱并体味这份全新的火锅感受；', '1', '重庆市沙坪坝区景苑路8号附18号1F-25', '15983699452', '家常4.png', '1', '4', '2');
INSERT INTO `mer` VALUES ('7', '加禧港式茶餐厅（解放碑店）', '我们的团队倾心打造至高品味的美食场所，创立了中餐特色餐饮品牌，将传统大型中餐与特色餐饮相结合，形成独特的店中店模式，满足不同消费群体的不同需求。专业的团队，个性化的装修、极显人性化的亲和服务。一直以来，金海华对美食的执着与创新，精彩的演绎着美食的至高境界。', '1', '重庆市沙坪坝区景和路42号', '19824728415', '家常5.png', '1', '11', '5');
INSERT INTO `mer` VALUES ('8', '佳居饭庄（兴科一路）', '本店的食品，饮品，新鲜、干净，卫生.本店成立以来一直致力于，制作，传播新颖，美味，独特的食品。原材料干净卫生，制作认真严谨。只愿给顾客带来更好的体验。', '13', '重庆市沙坪坝区景苑路8号附236号', '17881607259', '家常6.png', '1', '186', '90');
INSERT INTO `mer` VALUES ('9', '佳乐饭庄', '本店的食品，饮品，新鲜、干净，卫生.本店成立以来一直致力于，制作，传播新颖，美味，独特的食品。原材料干净卫生，制作认真严谨。只愿给顾客带来更好的体验。', '13', '重庆市沙坪坝区熙街11号楼1F-04', '17230679587', '家常7.png', '1', '171', '83');
INSERT INTO `mer` VALUES ('10', '佳肴干锅', '蜜雪冰城致力于让全球每个人享受高质平价的美味，始终秉承“近者悦，远者来；以奋斗者为本，以顾客为中心”的理念，用优质的原材料打造产品，以优质的团队服务顾客。', '5', '重庆市沙坪坝区陈家桥桥北路18号附10号', '13620604389', '家常8.png', '1', '66', '32');
INSERT INTO `mer` VALUES ('11', '金翠河港式茶餐厅（龙湖U城天街店）', '本店的食品，饮品，新鲜、干净，卫生.本店成立以来一直致力于，制作，传播新颖，美味，独特的食品。原材料干净卫生，制作认真严谨。只愿给顾客带来更好的体验。', '1', '重庆市沙坪坝区景苑路与大学城北路交叉口东南140米', '17817349377', '家常9.png', '1', '7', '4');
INSERT INTO `mer` VALUES ('12', '金翠河烧鹅餐厅（涪陵店）', '本店的食品，饮品，新鲜、干净，卫生.本店成立以来一直致力于，制作，传播新颖，美味，独特的食品。原材料干净卫生，制作认真严谨。只愿给顾客带来更好的体验。', '23', '重庆市南岸区黄桷垭正街150号第四人民医院沿西北方往木子园方向前行200米老君洞南门牌坊处', '17803946147', '家常10.png', '1', '212', '8');
INSERT INTO `mer` VALUES ('13', '金翠河烧鹅餐厅（南坪万达店）', '本店的食品，饮品，新鲜、干净，卫生.本店成立以来一直致力于，制作，传播新颖，美味，独特的食品。原材料干净卫生，制作认真严谨。只愿给顾客带来更好的体验。', '1', '重庆市巴南区红光大道杰信华府广场东北侧约50米', '18568995526', '布拉诺.jpg', '1', '9', '5');
INSERT INTO `mer` VALUES ('14', '金翠河烧鹅餐厅（时代广场店）', '本店的食品，饮品，新鲜、干净，卫生.本店成立以来一直致力于，制作，传播新颖，美味，独特的食品。原材料干净卫生，制作认真严谨。只愿给顾客带来更好的体验。', '1', '重庆市万州区天城镇塘坊还房B栋1幢二楼', '17798429770', '抄手1.png', '1', '2', '1');
INSERT INTO `mer` VALUES ('15', '金牌泰香米泰国餐厅（万象城店）', '本店的食品，饮品，新鲜、干净，卫生.本店成立以来一直致力于，制作，传播新颖，美味，独特的食品。原材料干净卫生，制作认真严谨。只愿给顾客带来更好的体验。', '17', '重庆市巫山县桐子坪巫山大酒店', '18896893756', '披萨.png  ', '1', '198', '96');
INSERT INTO `mer` VALUES ('16', '楼兰新疆主题餐厅（龙湖时代天街店）', '本店的食品，饮品，新鲜、干净，卫生.本店成立以来一直致力于，制作，传播新颖，美味，独特的食品。原材料干净卫生，制作认真严谨。只愿给顾客带来更好的体验。', '21', '重庆市渝中区长江支路11号(大坪地铁站5号口步行180米)', '18715441229', '楼兰.jpg', '1', '205', '99');
INSERT INTO `mer` VALUES ('17', '楼兰新疆主题餐厅（渝中来福士店）', '2013年，喜茶HEYTEA起源于江边里的一条小巷，原名皇茶ROYALTEA为了与层出不穷的山寨品牌区分开来，故全面升级为注册品牌喜茶HEYTEA。', '21', '重庆市沙坪坝区大学城景苑路8号附38至41号', '13029756170', '沙拉.png', '1', '203', '98');
INSERT INTO `mer` VALUES ('18', '泰香米泰国餐厅（北城天街店）', '我们的团队在这里北欧风格的后现代元素与奔放的埃及风会同重庆火锅的炽热，完美地融为一体！精致的产品、精细的服务又体现了过江龙对现代都市人消费观念的完全认同！我们完全有理由淡忘喧闹的码头传统，激情拥抱并体味这份全新的火锅感受；', '17', '重庆市沙坪坝区景和路青年文艺广场2-号', '15221708687', '泰香米.jpg', '1', '195', '94');
INSERT INTO `mer` VALUES ('19', '渝都饭庄', '本店是正宗地道的香港美食品牌，自2006年成立以来一-直致力于传播原汁原味、独具特色的香港饮食文化。品牌承继传统港式茶餐厅特色，菜品丰富、口味独特。吃烧鹅，金翠河，享粵菜，可青睐。', '2', '沙坪坝区大学城龙湖U城天街B馆L3-24', '19830569553', '火锅.jpg', '1', '46', '22');
INSERT INTO `mer` VALUES ('20', '裕农饭馆', '我们的团队深度开发新派精品新疆菜，涵括疆内各地特色美食、民族糕点，以弘扬传统饮食文化为已任，令您足不出户尝遍地道新疆特色菜肴！主营以新疆稀有珍品烹煮之精品佳肴，品位常新，应有尽有！', '2', '重庆市九龙坡区谢家湾正街55号万象城4层86号', '14779436756', '豆花1.png', '1', '59', '28');
INSERT INTO `mer` VALUES ('23', '王励饭店', '12346', '31', '重庆沙坪坝', '17823811293', '豆花1.png', '1', '304', '1');
INSERT INTO `mer` VALUES ('25', '家伟奶茶店', '家伟秘制奶茶，好喝的很', '33', '重庆沙坪坝', '17823811291', '奶茶4.png', '1', '181', '64');
INSERT INTO `mer` VALUES ('28', '张三饭店', '12', '33', '重庆沙坪坝', '17823811291', '加荷.jpg', '1', '282', '78');
INSERT INTO `mer` VALUES ('29', '李四奶茶店', '123', '33', '重庆沙坪坝', '17823811292', '奶茶4.png', '1', '13', '54');
INSERT INTO `mer` VALUES ('33', '王励面包店', '好得很', '36', '重庆沙坪坝', '17341561635', '奶茶4.png', '1', '164', '130');
INSERT INTO `mer` VALUES ('34', '运驰饭店', '好', '37', '重庆沙坪坝', '17823811297', '家常4.png', '1', '39', '131');
...
INSERT INTO `mertype` VALUES ('31', '饮料');
INSERT INTO `mertype` VALUES ('32', '家伟秘制家常菜');
INSERT INTO `mertype` VALUES ('33', '奶茶');
INSERT INTO `mertype` VALUES ('36', '面包');
INSERT INTO `mertype` VALUES ('37', '稀饭');
...
CREATE TABLE `orderdetails` (
  ...
  KEY `m_id` (`m_id`) USING BTREE,
  KEY `g_id` (`g_id`) USING BTREE,
  CONSTRAINT `orderdetails_ibfk_1` FOREIGN KEY (`m_id`) REFERENCES `mer` (`m_id`),
  CONSTRAINT `orderdetails_ibfk_2` FOREIGN KEY (`g_id`) REFERENCES `goods` (`g_id`),
  CONSTRAINT `orderdetails_ibfk_3` FOREIGN KEY (`o_id`) REFERENCES `orderlist` (`o_id`)
) ENGINE=InnoDB AUTO_INCREMENT=850 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
INSERT INTO `orderdetails` VALUES ('601', '209', '7', '61');
INSERT INTO `orderdetails` VALUES ('602', '209', '7', '62');
INSERT INTO `orderdetails` VALUES ('603', '211', '1', '1');
INSERT INTO `orderdetails` VALUES ('604', '212', '1', '1');
INSERT INTO `orderdetails` VALUES ('605', '212', '1', '2');
INSERT INTO `orderdetails` VALUES ('606', '214', '1', '1');
INSERT INTO `orderdetails` VALUES ('607', '214', '1', '2');
INSERT INTO `orderdetails` VALUES ('608', '215', '1', '1');
INSERT INTO `orderdetails` VALUES ('609', '215', '1', '1');
INSERT INTO `orderdetails` VALUES ('610', '215', '1', '2');
INSERT INTO `orderdetails` VALUES ('611', '215', '1', '3');
INSERT INTO `orderdetails` VALUES ('612', '217', '1', '1');
INSERT INTO `orderdetails` VALUES ('613', '217', '1', '2');
INSERT INTO `orderdetails` VALUES ('614', '225', '1', '1');
INSERT INTO `orderdetails` VALUES ('615', '225', '1', '2');
INSERT INTO `orderdetails` VALUES ('616', '227', '1', '1');
INSERT INTO `orderdetails` VALUES ('617', '227', '1', '2');
INSERT INTO `orderdetails` VALUES ('618', '228', '1', '1');
INSERT INTO `orderdetails` VALUES ('619', '228', '1', '2');
INSERT INTO `orderdetails` VALUES ('620', '228', '1', '4');
INSERT INTO `orderdetails` VALUES ('621', '229', '1', '1');
INSERT INTO `orderdetails` VALUES ('622', '229', '1', '2');
INSERT INTO `orderdetails` VALUES ('623', '230', '1', '1');
INSERT INTO `orderdetails` VALUES ('624', '230', '1', '2');
INSERT INTO `orderdetails` VALUES ('625', '230', '1', '1');
INSERT INTO `orderdetails` VALUES ('626', '231', '5', '41');
INSERT INTO `orderdetails` VALUES ('627', '231', '5', '42');
INSERT INTO `orderdetails` VALUES ('628', '232', '5', '41');
INSERT INTO `orderdetails` VALUES ('629', '232', '5', '42');
INSERT INTO `orderdetails` VALUES ('630', '233', '3', '23');
INSERT INTO `orderdetails` VALUES ('631', '233', '3', '22');
INSERT INTO `orderdetails` VALUES ('632', '234', '6', '51');
INSERT INTO `orderdetails` VALUES ('633', '234', '6', '52');
INSERT INTO `orderdetails` VALUES ('634', '235', '2', '11');
INSERT INTO `orderdetails` VALUES ('635', '235', '2', '12');
INSERT INTO `orderdetails` VALUES ('636', '236', '1', '1');
INSERT INTO `orderdetails` VALUES ('637', '236', '1', '2');
INSERT INTO `orderdetails` VALUES ('638', '237', '1', '1');
INSERT INTO `orderdetails` VALUES ('639', '237', '1', '2');
INSERT INTO `orderdetails` VALUES ('640', '238', '1', '1');
INSERT INTO `orderdetails` VALUES ('641', '238', '1', '2');
INSERT INTO `orderdetails` VALUES ('642', '239', '2', '13');
INSERT INTO `orderdetails` VALUES ('643', '240', '1', '10');
INSERT INTO `orderdetails` VALUES ('644', '241', '17', '161');
INSERT INTO `orderdetails` VALUES ('645', '242', '7', '61');
INSERT INTO `orderdetails` VALUES ('646', '243', '1', '9');
INSERT INTO `orderdetails` VALUES ('647', '243', '1', '1');
INSERT INTO `orderdetails` VALUES ('648', '243', '1', '9');
INSERT INTO `orderdetails` VALUES ('649', '243', '1', '9');
INSERT INTO `orderdetails` VALUES ('650', '243', '1', '9');
INSERT INTO `orderdetails` VALUES ('651', '244', '9', '81');
INSERT INTO `orderdetails` VALUES ('652', '244', '9', '81');
INSERT INTO `orderdetails` VALUES ('653', '244', '9', '81');
INSERT INTO `orderdetails` VALUES ('654', '244', '9', '81');
INSERT INTO `orderdetails` VALUES ('655', '244', '9', '81');
INSERT INTO `orderdetails` VALUES ('656', '244', '9', '81');
INSERT INTO `orderdetails` VALUES ('657', '244', '9', '81');
INSERT INTO `orderdetails` VALUES ('658', '244', '9', '81');
INSERT INTO `orderdetails` VALUES ('659', '244', '9', '81');
INSERT INTO `orderdetails` VALUES ('660', '244', '9', '81');
INSERT INTO `orderdetails` VALUES ('661', '245', '5', '41');
INSERT INTO `orderdetails` VALUES ('662', '245', '5', '41');
INSERT INTO `orderdetails` VALUES ('663', '245', '5', '41');
INSERT INTO `orderdetails` VALUES ('664', '245', '5', '41');
INSERT INTO `orderdetails` VALUES ('665', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('666', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('667', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('668', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('669', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('670', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('671', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('672', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('673', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('674', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('675', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('676', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('677', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('678', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('679', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('680', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('681', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('682', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('683', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('684', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('685', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('686', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('687', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('688', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('689', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('690', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('691', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('692', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('693', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('694', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('695', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('696', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('697', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('698', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('699', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('700', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('701', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('702', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('703', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('704', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('705', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('706', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('707', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('708', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('709', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('710', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('711', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('712', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('713', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('714', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('715', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('716', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('717', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('718', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('719', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('720', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('721', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('722', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('723', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('724', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('725', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('726', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('727', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('728', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('729', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('730', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('731', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('732', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('733', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('734', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('735', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('736', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('737', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('738', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('739', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('740', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('741', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('742', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('743', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('744', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('745', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('746', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('747', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('748', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('749', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('750', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('751', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('752', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('753', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('754', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('755', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('756', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('757', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('758', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('759', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('760', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('761', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('762', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('763', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('764', '247', '1', '1');
INSERT INTO `orderdetails` VALUES ('765', '248', '1', '1');
INSERT INTO `orderdetails` VALUES ('766', '248', '1', '1');
INSERT INTO `orderdetails` VALUES ('767', '248', '1', '1');
INSERT INTO `orderdetails` VALUES ('768', '248', '1', '2');
INSERT INTO `orderdetails` VALUES ('769', '249', '8', '72');
INSERT INTO `orderdetails` VALUES ('770', '249', '8', '71');
INSERT INTO `orderdetails` VALUES ('771', '250', '1', '1');
INSERT INTO `orderdetails` VALUES ('772', '250', '1', '1');
INSERT INTO `orderdetails` VALUES ('773', '250', '1', '1');
INSERT INTO `orderdetails` VALUES ('774', '250', '1', '1');
INSERT INTO `orderdetails` VALUES ('775', '250', '1', '1');
INSERT INTO `orderdetails` VALUES ('776', '250', '1', '1');
INSERT INTO `orderdetails` VALUES ('777', '250', '1', '1');
INSERT INTO `orderdetails` VALUES ('778', '250', '1', '1');
INSERT INTO `orderdetails` VALUES ('779', '250', '1', '1');
INSERT INTO `orderdetails` VALUES ('780', '250', '1', '1');
INSERT INTO `orderdetails` VALUES ('781', '251', '1', '2');
INSERT INTO `orderdetails` VALUES ('782', '254', '1', '2');
INSERT INTO `orderdetails` VALUES ('783', '254', '1', '1');
INSERT INTO `orderdetails` VALUES ('784', '259', '1', '1');
INSERT INTO `orderdetails` VALUES ('785', '259', '1', '2');
INSERT INTO `orderdetails` VALUES ('786', '260', '13', '121');
INSERT INTO `orderdetails` VALUES ('787', '260', '13', '122');
INSERT INTO `orderdetails` VALUES ('788', '263', '1', '1');
INSERT INTO `orderdetails` VALUES ('789', '263', '1', '2');
INSERT INTO `orderdetails` VALUES ('790', '264', '1', '2');
INSERT INTO `orderdetails` VALUES ('791', '264', '1', '2');
INSERT INTO `orderdetails` VALUES ('792', '265', '5', '41');
INSERT INTO `orderdetails` VALUES ('793', '266', '3', '21');
INSERT INTO `orderdetails` VALUES ('794', '267', '1', '1');
INSERT INTO `orderdetails` VALUES ('795', '267', '1', '2');
INSERT INTO `orderdetails` VALUES ('796', '268', '1', '1');
INSERT INTO `orderdetails` VALUES ('797', '268', '1', '2');
INSERT INTO `orderdetails` VALUES ('798', '268', '1', '2');
INSERT INTO `orderdetails` VALUES ('799', '268', '1', '2');
INSERT INTO `orderdetails` VALUES ('800', '269', '6', '52');
INSERT INTO `orderdetails` VALUES ('801', '269', '6', '52');
INSERT INTO `orderdetails` VALUES ('802', '269', '6', '52');
INSERT INTO `orderdetails` VALUES ('803', '270', '3', '21');
INSERT INTO `orderdetails` VALUES ('804', '271', '1', '1');
INSERT INTO `orderdetails` VALUES ('805', '271', '1', '2');
INSERT INTO `orderdetails` VALUES ('806', '271', '1', '2');
INSERT INTO `orderdetails` VALUES ('807', '271', '1', '2');
INSERT INTO `orderdetails` VALUES ('808', '271', '1', '2');
INSERT INTO `orderdetails` VALUES ('809', '271', '1', '2');
INSERT INTO `orderdetails` VALUES ('810', '271', '1', '2');
INSERT INTO `orderdetails` VALUES ('811', '271', '1', '2');
INSERT INTO `orderdetails` VALUES ('812', '271', '1', '2');
INSERT INTO `orderdetails` VALUES ('813', '271', '1', '2');
INSERT INTO `orderdetails` VALUES ('814', '271', '1', '2');
INSERT INTO `orderdetails` VALUES ('815', '271', '1', '1');
INSERT INTO `orderdetails` VALUES ('816', '271', '1', '1');
INSERT INTO `orderdetails` VALUES ('817', '271', '1', '1');
INSERT INTO `orderdetails` VALUES ('818', '271', '1', '1');
INSERT INTO `orderdetails` VALUES ('819', '271', '1', '1');
INSERT INTO `orderdetails` VALUES ('820', '271', '1', '1');
INSERT INTO `orderdetails` VALUES ('821', '271', '1', '1');
INSERT INTO `orderdetails` VALUES ('822', '271', '1', '1');
INSERT INTO `orderdetails` VALUES ('823', '271', '1', '1');
INSERT INTO `orderdetails` VALUES ('824', '272', '1', '1');
INSERT INTO `orderdetails` VALUES ('825', '272', '1', '2');
INSERT INTO `orderdetails` VALUES ('826', '273', '1', '1');
INSERT INTO `orderdetails` VALUES ('827', '273', '1', '1');
INSERT INTO `orderdetails` VALUES ('828', '273', '1', '1');
INSERT INTO `orderdetails` VALUES ('829', '273', '1', '1');
INSERT INTO `orderdetails` VALUES ('830', '273', '1', '1');
INSERT INTO `orderdetails` VALUES ('831', '273', '1', '2');
INSERT INTO `orderdetails` VALUES ('832', '273', '1', '2');
INSERT INTO `orderdetails` VALUES ('833', '273', '1', '2');
INSERT INTO `orderdetails` VALUES ('834', '273', '1', '2');
INSERT INTO `orderdetails` VALUES ('835', '273', '1', '2');
INSERT INTO `orderdetails` VALUES ('836', '274', '1', '2');
INSERT INTO `orderdetails` VALUES ('837', '274', '1', '1');
INSERT INTO `orderdetails` VALUES ('838', '275', '1', '3');
INSERT INTO `orderdetails` VALUES ('839', '275', '1', '2');
INSERT INTO `orderdetails` VALUES ('840', '276', '33', '201');
INSERT INTO `orderdetails` VALUES ('841', '276', '33', '201');
INSERT INTO `orderdetails` VALUES ('842', '276', '33', '201');
INSERT INTO `orderdetails` VALUES ('843', '276', '33', '201');
INSERT INTO `orderdetails` VALUES ('844', '277', '1', '1');
INSERT INTO `orderdetails` VALUES ('845', '277', '1', '2');
INSERT INTO `orderdetails` VALUES ('846', '278', '1', '1');
INSERT INTO `orderdetails` VALUES ('847', '278', '1', '2');
INSERT INTO `orderdetails` VALUES ('848', '279', '1', '1');
INSERT INTO `orderdetails` VALUES ('849', '280', '1', '1');
...
CREATE TABLE `orderlist` (
  ...
  `o_statue` varchar(255) DEFAULT NULL,
  `o_isuse` varchar(255) DEFAULT NULL,
  `d_couponnum` varchar(255) DEFAULT NULL,
  `o_method` varchar(255) DEFAULT NULL,
  `o_paustatue` varchar(255) DEFAULT NULL,
  `m_id` int(11) DEFAULT NULL,
  `u_id` int(11) DEFAULT NULL,
  `o_begintime` datetime DEFAULT NULL,
  `o_estimate` datetime DEFAULT NULL,
  `o_endtime` datetime DEFAULT NULL,
  PRIMARY KEY (`o_id`) USING BTREE,
  KEY `m_id` (`m_id`) USING BTREE,
  KEY `u_id` (`u_id`) USING BTREE,
  KEY `d_couponnum` (`d_couponnum`) USING BTREE,
  CONSTRAINT `orderlist_ibfk_2` FOREIGN KEY (`m_id`) REFERENCES `mer` (`m_id`),
  CONSTRAINT `orderlist_ibfk_3` FOREIGN KEY (`u_id`) REFERENCES `userinfo` (`u_id`)
...
INSERT INTO `orderlist` VALUES ('18', 'T389GW', '16631957082', '重庆市沙坪坝区景苑路与大学城北路交叉口东南140米', '等待付款', '1', '10EXCCES', '微信', '未支付', '11', '126', '2022-03-24 05:41:36', '2022-03-24 07:05:45', null);
...
INSERT INTO `orderlist` VALUES ('203', 'ERMD5N2IL', '17854502205', '贵州省安顺市南岔区包头南路29号菊园五街坊', '等待出货', '1', '23EXCCES', '微信', '已支付', '17', '17', '2022-06-12 20:25:05', '2022-06-12 20:55:05', '2022-06-12 20:44:05');
INSERT INTO `orderlist` VALUES ('204', 'SULCU4SL', '14452700202', '贵州省安顺市南岔区包头南路29号菊园五街坊', '等待出货', '1', '23EXCCES', '云闪付', '已支付', '17', '17', '2022-06-13 14:06:20', '2022-06-13 14:36:20', '2022-06-13 14:17:20');
INSERT INTO `orderlist` VALUES ('205', 'XNGYD6R3P', '16103571660', '贵州省安顺市南岔区包头南路29号菊园五街坊', '等待出货', '1', '23EXCCES', '微信', '已支付', '17', '17', '2022-06-13 14:50:57', '2022-06-13 15:20:57', '2022-06-13 15:07:57');
INSERT INTO `orderlist` VALUES ('206', '2JV6MWLK5O', '10673322327', '贵州省安顺市南岔区包头南路29号菊园五街坊', '等待出货', '1', '23EXCCES', '微信', '已支付', '1', '17', '2022-06-13 15:09:00', '2022-06-13 15:39:00', '2022-06-13 15:31:00');
INSERT INTO `orderlist` VALUES ('207', 'DI6ZXXU2X', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '1', '23EXCCES', '云闪付', '已支付', '1', '99', '2022-06-13 15:14:26', '2022-06-13 15:44:26', '2022-06-13 15:34:26');
INSERT INTO `orderlist` VALUES ('208', '1A8UZMFHT', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '1', '25EXCCES', '微信', '已支付', '1', '99', '2022-06-13 15:17:52', '2022-06-13 15:47:52', '2022-06-13 15:27:52');
INSERT INTO `orderlist` VALUES ('209', 'IQO5IG7AF', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '云闪付', '已支付', '7', '99', '2022-06-13 15:45:32', '2022-06-13 16:15:32', '2022-06-13 16:09:32');
INSERT INTO `orderlist` VALUES ('211', 'YKNFKV2X', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '微信', '已支付', '1', '99', '2022-06-13 16:02:04', '2022-06-13 16:32:04', '2022-06-13 16:31:04');
INSERT INTO `orderlist` VALUES ('212', 'EHMZMD4X', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '支付宝', '已支付', '1', '99', '2022-06-13 16:10:25', '2022-06-13 16:40:25', '2022-06-13 16:30:25');
INSERT INTO `orderlist` VALUES ('213', '2IB7ARLAQ', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '已被用户取消', '0', null, '支付宝', '未支付', '1', '99', '2022-06-13 16:13:40', null, null);
INSERT INTO `orderlist` VALUES ('214', 'YZCA3QFI', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '云闪付', '已支付', '1', '99', '2022-06-14 11:57:58', '2022-06-14 12:27:58', '2022-06-14 12:24:58');
INSERT INTO `orderlist` VALUES ('215', 'BXPD3PXG', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '支付宝', '已支付', '1', '99', '2022-06-14 12:04:33', '2022-06-14 12:34:33', '2022-06-14 12:14:33');
INSERT INTO `orderlist` VALUES ('216', 'KAVMSI8Y', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '已被用户取消', '0', null, '微信', '未支付', '1', '99', '2022-06-14 12:07:19', null, null);
INSERT INTO `orderlist` VALUES ('217', 'KSBHLU7M', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '云闪付', '已支付', '1', '99', '2022-06-14 12:22:32', '2022-06-14 12:52:32', '2022-06-14 12:49:32');
INSERT INTO `orderlist` VALUES ('218', 'SWJAV4JL', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '已被用户取消', '0', null, '云闪付', '未支付', '4', '99', '2022-06-14 12:59:35', null, null);
INSERT INTO `orderlist` VALUES ('219', 'L3TF1QTJD', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '已被用户取消', '1', '13EXCCES', '微信', '未支付', '1', '99', '2022-06-14 13:02:03', null, null);
INSERT INTO `orderlist` VALUES ('220', 'KEO7RHEF', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '已被用户取消', '1', '01EXCCES', '微信', '未支付', '1', '99', '2022-06-14 13:03:19', null, null);
INSERT INTO `orderlist` VALUES ('221', 'NAKI6MU9F', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '已被用户取消', '1', '01EXCCES', '微信', '未支付', '1', '99', '2022-06-14 13:10:28', null, null);
INSERT INTO `orderlist` VALUES ('222', 'K5HDIS7PG', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '已被用户取消', '1', '13EXCCES', '微信', '未支付', '1', '99', '2022-06-14 13:12:48', null, null);
INSERT INTO `orderlist` VALUES ('223', 'RVLJZK8R', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '已被用户取消', '1', '01EXCCES', '微信', '未支付', '1', '99', '2022-06-14 13:18:21', null, null);
INSERT INTO `orderlist` VALUES ('224', 'OJIA9GRC', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '已被用户取消', '1', '25EXCCES', '微信', '未支付', '1', '99', '2022-06-14 13:25:12', null, null);
INSERT INTO `orderlist` VALUES ('225', 'FZB1GABL', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '1', '17EXCCES', '云闪付', '已支付', '1', '99', '2022-06-14 13:25:23', '2022-06-14 13:55:23', '2022-06-14 13:50:23');
INSERT INTO `orderlist` VALUES ('226', 'NV6RLHQ1Q', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '已被用户取消', '1', '13EXCCES', '微信', '未支付', '1', '99', '2022-06-14 13:37:38', null, null);
INSERT INTO `orderlist` VALUES ('227', 'QDO7HWGE', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '1', '13EXCCES', '云闪付', '已支付', '1', '99', '2022-06-14 19:14:07', '2022-06-14 19:44:07', '2022-06-14 19:41:07');
INSERT INTO `orderlist` VALUES ('228', '8KQBWDZN', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '1', '17EXCCES', '支付宝', '已支付', '1', '99', '2022-06-15 00:35:04', '2022-06-15 01:05:04', '2022-06-15 00:56:04');
INSERT INTO `orderlist` VALUES ('229', 'Q7TAYXOG', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '1', '01EXCCES', '支付宝', '已支付', '1', '99', '2022-06-15 09:15:52', '2022-06-15 09:45:52', '2022-06-15 09:39:52');
INSERT INTO `orderlist` VALUES ('230', 'O7KVSVZR', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '支付宝', '已支付', '1', '99', '2022-06-15 09:51:26', '2022-06-15 10:21:26', '2022-06-15 10:10:26');
INSERT INTO `orderlist` VALUES ('231', 'IY6LHPY6W', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '云闪付', '已支付', '5', '99', '2022-06-15 09:52:18', '2022-06-15 10:22:18', '2022-06-15 10:02:18');
INSERT INTO `orderlist` VALUES ('232', 'ADUZ3AUV', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '云闪付', '已支付', '5', '99', '2022-06-15 09:52:33', '2022-06-15 10:22:33', '2022-06-15 10:06:33');
INSERT INTO `orderlist` VALUES ('233', '8TGVMDWV', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '支付宝', '已支付', '3', '99', '2022-06-15 09:55:12', '2022-06-15 10:25:12', '2022-06-15 10:11:12');
INSERT INTO `orderlist` VALUES ('234', 'AJS3SVNS', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '云闪付', '已支付', '6', '99', '2022-06-15 09:59:42', '2022-06-15 10:29:42', '2022-06-15 10:22:42');
INSERT INTO `orderlist` VALUES ('235', 'DC9YJEXH', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '云闪付', '已支付', '2', '99', '2022-06-15 10:28:49', '2022-06-15 10:58:49', '2022-06-15 10:41:49');
INSERT INTO `orderlist` VALUES ('236', 'C8FIITRK', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '云闪付', '已支付', '1', '99', '2022-06-15 10:32:12', '2022-06-15 11:02:12', '2022-06-15 10:50:12');
INSERT INTO `orderlist` VALUES ('237', 'MNA5XG7PU', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '1', '25EXCCES', '云闪付', '已支付', '1', '99', '2022-06-15 14:01:09', '2022-06-15 14:31:09', '2022-06-15 14:23:09');
INSERT INTO `orderlist` VALUES ('238', 'FBTGVD7A', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '1', '25EXCCES', '云闪付', '已支付', '1', '99', '2022-06-15 15:03:01', '2022-06-15 15:33:01', '2022-06-15 15:21:01');
INSERT INTO `orderlist` VALUES ('239', 'XJD3JALW', '17823811291', '重庆渝北区', '等待出货', '0', null, '支付宝', '已支付', '2', '203', '2022-06-15 15:08:08', '2022-06-15 15:38:08', '2022-06-15 15:22:08');
INSERT INTO `orderlist` VALUES ('240', 'PYCLS5LI', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '云闪付', '已支付', '1', '99', '2022-06-15 15:12:43', '2022-06-15 15:42:43', '2022-06-15 15:39:43');
INSERT INTO `orderlist` VALUES ('241', 'QW7SXGVB', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '云闪付', '已支付', '17', '99', '2022-06-15 15:14:38', '2022-06-15 15:44:38', '2022-06-15 15:43:38');
INSERT INTO `orderlist` VALUES ('242', 'EKGKNJ6O', '17823811291', '重庆渝北区', '等待出货', '0', null, '支付宝', '已支付', '7', '203', '2022-06-15 15:20:39', '2022-06-15 15:50:39', '2022-06-15 15:34:39');
INSERT INTO `orderlist` VALUES ('243', 'URJO5U5MZ', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '支付宝', '已支付', '1', '99', '2022-06-15 16:08:10', '2022-06-15 16:38:10', '2022-06-15 16:37:10');
INSERT INTO `orderlist` VALUES ('244', 'G9ZWOBGL', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '云闪付', '已支付', '9', '99', '2022-06-15 16:15:49', '2022-06-15 16:45:49', '2022-06-15 16:33:49');
INSERT INTO `orderlist` VALUES ('245', 'BC9ANTRU', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '支付宝', '已支付', '5', '99', '2022-06-15 16:39:43', '2022-06-15 17:09:43', '2022-06-15 16:49:43');
INSERT INTO `orderlist` VALUES ('246', 'DI3P4J4AGA', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '已被用户取消', '1', '01EXCCES', '云闪付', '未支付', '4', '99', '2022-06-15 16:40:29', null, null);
INSERT INTO `orderlist` VALUES ('247', 'NZSN2KDT', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '云闪付', '已支付', '1', '99', '2022-06-15 16:49:33', '2022-06-15 17:19:33', '2022-06-15 17:00:33');
INSERT INTO `orderlist` VALUES ('248', 'RQSI6HD3G', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '1', '01EXCCES', '云闪付', '已支付', '1', '99', '2022-06-20 16:23:27', '2022-06-20 16:53:27', '2022-06-20 16:33:27');
INSERT INTO `orderlist` VALUES ('249', 'AVZH9KOG', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '支付宝', '已支付', '8', '99', '2022-06-20 16:33:57', '2022-06-20 17:03:57', '2022-06-20 16:55:57');
INSERT INTO `orderlist` VALUES ('250', '1F7HQROHN', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '云闪付', '已支付', '1', '99', '2022-06-20 16:35:48', '2022-06-20 17:05:48', '2022-06-20 16:58:48');
INSERT INTO `orderlist` VALUES ('251', 'IZAY2MYK', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '支付宝', '已支付', '1', '99', '2022-06-20 16:37:46', '2022-06-20 17:07:46', '2022-06-20 16:52:46');
INSERT INTO `orderlist` VALUES ('252', '2CI4EQ4SUX', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '已被用户取消', '0', null, '云闪付', '未支付', '1', '99', '2022-06-20 17:06:54', null, null);
INSERT INTO `orderlist` VALUES ('253', 'U1KUPESF', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '已被用户取消', '0', null, '云闪付', '未支付', '1', '99', '2022-06-20 17:07:34', null, null);
INSERT INTO `orderlist` VALUES ('254', 'VEX7FPKF', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '1', '13EXCCES', '支付宝', '已支付', '1', '99', '2022-06-20 18:57:59', '2022-06-20 19:27:59', '2022-06-20 19:09:59');
INSERT INTO `orderlist` VALUES ('255', 'EE9JPIBZ', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '已被用户取消', '1', '25EXCCES', '云闪付', '未支付', '1', '99', '2022-06-20 20:08:03', null, null);
INSERT INTO `orderlist` VALUES ('256', 'F6KORVV8B', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '已被用户取消', '1', '01EXCCES', '微信', '未支付', '1', '99', '2022-06-20 20:11:34', null, null);
INSERT INTO `orderlist` VALUES ('257', 'OQORKB3U', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '已被用户取消', '0', null, '微信', '未支付', '1', '99', '2022-06-20 20:12:16', null, null);
INSERT INTO `orderlist` VALUES ('258', 'PHRHN9EL', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '已被用户取消', '0', null, '微信', '未支付', '1', '99', '2022-06-20 20:16:49', null, null);
INSERT INTO `orderlist` VALUES ('259', 'YZPP2BZG', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '云闪付', '已支付', '1', '99', '2022-06-20 20:58:18', '2022-06-20 21:28:18', '2022-06-20 21:10:18');
INSERT INTO `orderlist` VALUES ('260', 'OGC3TIAP', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '1', '01EXCCES', '云闪付', '已支付', '13', '99', '2022-06-20 20:59:14', '2022-06-20 21:29:14', '2022-06-20 21:25:14');
INSERT INTO `orderlist` VALUES ('261', 'KFDXT6E6H', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '已被用户取消', '1', '01EXCCES', '微信', '未支付', '1', '99', '2022-06-20 21:06:56', null, null);
INSERT INTO `orderlist` VALUES ('262', 'S4OIP1BII', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '已被用户取消', '0', null, '微信', '未支付', '1', '99', '2022-06-20 21:07:13', null, null);
INSERT INTO `orderlist` VALUES ('263', 'NVE9ZMUN', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '云闪付', '已支付', '1', '99', '2022-06-20 21:16:42', '2022-06-20 21:46:42', '2022-06-20 21:32:42');
INSERT INTO `orderlist` VALUES ('264', 'DFYXOS2C', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '云闪付', '已支付', '1', '99', '2022-06-20 22:10:21', '2022-06-20 22:40:21', '2022-06-20 22:22:21');
INSERT INTO `orderlist` VALUES ('265', 'LT3I5TS5QO', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '微信', '已支付', '5', '99', '2022-06-20 22:10:44', '2022-06-20 22:40:44', '2022-06-20 22:26:44');
INSERT INTO `orderlist` VALUES ('266', 'RE9VKTPL', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '微信', '已支付', '3', '99', '2022-06-20 22:10:57', '2022-06-20 22:40:57', '2022-06-20 22:33:57');
INSERT INTO `orderlist` VALUES ('267', 'ZA9XTEDH', '17823811291', '重庆渝北区', '等待出货', '0', null, '云闪付', '已支付', '1', '203', '2022-06-20 22:53:35', '2022-06-20 23:23:35', '2022-06-20 23:10:35');
INSERT INTO `orderlist` VALUES ('268', 'DI1BBJYA', '17823811291', '重庆渝北区', '等待出货', '0', null, '微信', '已支付', '1', '203', '2022-06-20 22:55:58', '2022-06-20 23:25:58', '2022-06-20 23:22:58');
INSERT INTO `orderlist` VALUES ('269', 'XMPT8RYZ', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '1', '13EXCCES', '云闪付', '已支付', '6', '99', '2022-06-20 22:58:47', '2022-06-20 23:28:47', '2022-06-20 23:22:47');
INSERT INTO `orderlist` VALUES ('270', 'IHCY2LOX', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '1', '01EXCCES', '云闪付', '已支付', '3', '99', '2022-06-20 22:59:07', '2022-06-20 23:29:07', '2022-06-20 23:18:07');
INSERT INTO `orderlist` VALUES ('271', 'D8WFIKSX', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '1', '01EXCCES', '云闪付', '已支付', '1', '99', '2022-06-22 09:24:48', '2022-06-22 09:54:48', '2022-06-22 09:38:48');
INSERT INTO `orderlist` VALUES ('272', 'FT7RVVNZ', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '1', '01EXCCES', '云闪付', '已支付', '1', '99', '2022-06-22 15:18:32', '2022-06-22 15:48:32', '2022-06-22 15:38:32');
INSERT INTO `orderlist` VALUES ('273', 'IXMVJW6M', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '1', '25EXCCES', '云闪付', '已支付', '1', '99', '2022-06-24 10:47:02', '2022-06-24 11:17:02', '2022-06-24 11:02:02');
INSERT INTO `orderlist` VALUES ('274', 'GOX1VLTI', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '1', '13EXCCES', '云闪付', '已支付', '1', '99', '2022-06-24 14:12:37', '2022-06-24 14:42:37', '2022-06-24 14:37:37');
INSERT INTO `orderlist` VALUES ('275', 'RUVDL8CO', '17823811297', '重庆沙坪坝', '等待出货', '0', null, '云闪付', '已支付', '1', '209', '2022-06-24 14:49:05', '2022-06-24 15:19:05', '2022-06-24 15:16:05');
INSERT INTO `orderlist` VALUES ('276', 'VM5DJP8OP', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '1', '13EXCCES', '支付宝', '已支付', '33', '99', '2022-06-24 15:12:51', '2022-06-24 15:42:51', '2022-06-24 15:36:51');
INSERT INTO `orderlist` VALUES ('277', 'FMAKZ1TL', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '1', '13EXCCES', '支付宝', '已支付', '1', '99', '2022-06-24 15:18:28', '2022-06-24 15:48:28', '2022-06-24 15:42:28');
INSERT INTO `orderlist` VALUES ('278', 'JX2KVPML', '12345678999', '重庆沙坪坝', '等待出货', '0', null, '微信', '已支付', '1', '210', '2022-06-24 15:30:13', '2022-06-24 16:00:13', '2022-06-24 15:53:13');
INSERT INTO `orderlist` VALUES ('279', 'SX9CRVBR', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '云闪付', '已支付', '1', '99', '2022-06-24 23:25:42', '2022-06-24 23:55:42', '2022-06-24 23:46:42');
INSERT INTO `orderlist` VALUES ('280', 'YBMIL9SY', '17341561635', '广东省安顺市南岔区白玉路107号爱里舍花园', '等待出货', '0', null, '微信', '已支付', '1', '99', '2022-06-24 23:26:42', '2022-06-24 23:56:42', '2022-06-24 23:45:42');
...
CREATE TABLE `prestige` (
  ...
  `p_blacklist` varchar(255) DEFAULT NULL,
  ...
  KEY `p_score` (`p_score`) USING BTREE,
  CONSTRAINT `prestige_ibfk_1` FOREIGN KEY (`u_id`) REFERENCES `userinfo` (`u_id`),
  CONSTRAINT `prestige_ibfk_2` FOREIGN KEY (`a_id`) REFERENCES `administrator` (`a_id`)
...
INSERT INTO `prestige` VALUES ('99', '95', '0', '优秀', '99', '19');
...
CREATE TABLE `userinfo` (
  ...
  `u_headimage` varchar(255) DEFAULT NULL,
  `u_account` varchar(255) DEFAULT NULL,
  `u_pwd` varchar(255) DEFAULT NULL,
  `v_viprank` int(11) DEFAULT NULL,
  `u_registertime` date DEFAULT NULL,
  `u_email` varchar(255) DEFAULT NULL,
  `u_nickname` varchar(255) DEFAULT NULL,
  `p_score` int(3) DEFAULT NULL,
  PRIMARY KEY (`u_id`) USING BTREE,
  KEY `v_viprank` (`v_viprank`) USING BTREE,
  KEY `p_score` (`p_score`) USING BTREE,
  CONSTRAINT `userinfo_ibfk_2` FOREIGN KEY (`v_viprank`) REFERENCES `vip` (`v_viprank`)
) ENGINE=InnoDB AUTO_INCREMENT=212 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of userinfo
-- ----------------------------
INSERT INTO `userinfo` VALUES ('1', '秃子默', '甘肃省白城市翠峦区白城路137号阳光翠竹苑', '14100212516', 'tx.png', '14100212516', 'Pl$ti3BJtQfkP^', '3', '2021-04-02', 'kp3m@163.com', '韦陀新苗', '100');
INSERT INTO `userinfo` VALUES ('2', '柴博远', '山东省白山市友好区安边路6号复华城市花园', '18366491884', 'tx.png', '18366491884', '@5~_G5vllG', '2', '2022-02-20', 'imyiyyq6ovj@163.com', '冰心傲菡', '100');
INSERT INTO `userinfo` VALUES ('3', '僧弘阔', '黑龙江省白银市新青区白渡路46号住友嘉馨名园', '17242007788', 'tx1.png', '17242007788', 'EZStv_KXYQF8', '4', '2021-10-05', 'hv2prug3ac0t6@163.com', '行云俊逸', '100');
INSERT INTO `userinfo` VALUES ('4', '鞠嘉赐', '海南省安庆市带岭区鞍山路195号阳光翠竹苑', '13845298623', 'tx.png', '13845298623', 'p%IfjLJ+', '1', '2022-04-17', '6umoc@163.com', '五轮夏海', '100');
INSERT INTO `userinfo` VALUES ('5', '东玉成', '海南省白银市新青区宝杨路23号溢盈河畔别墅', '17241003610', 'tx.png', '17241003610', '3t)Pe318oi', '3', '2021-12-03', 'mlhm2md@163.com', '傲寒茵茵', '95');
INSERT INTO `userinfo` VALUES ('6', '巩博文', '贵州省蚌埠市五营区安顺路28号协通公寓', '13313159973', 'tx.png', '13313159973', 'j4rcfOI6iR*s', '4', '2020-09-29', '6nxgg51z4uz1w@163.com', '蚀骨文赋', '100');
INSERT INTO `userinfo` VALUES ('7', '难成益', '甘肃省百色市上甘岭区安化路44号溢盈河畔别墅', '19101454856', 'tx.png', '19101454856', 'yK+8*^nw1U+&^%7', '2', '2021-03-02', 'vftfiqy2u@163.com', '黯然子瑜', '100');
INSERT INTO `userinfo` VALUES ('8', '丰阳舒', '山东省宝鸡市汤旺河区宝昌路121号真新六街坊', '17733242809', 'tx.png', '17733242809', 'Q5vr6bgQ', '4', '2020-09-23', 't6o3npufro4ultm@163.com', '北斗春枫', '100');
INSERT INTO `userinfo` VALUES ('9', '全飞羽', '江西省蚌埠市五营区安仁路80号耀江花园', '19859927274', 'tx.png', '19859927274', '%aRN!aSP8oJk!', '3', '2020-05-21', 'mgx@163.com', '杨家玉石', '100');
INSERT INTO `userinfo` VALUES ('10', '岑才艺', '福建省巴中市乌马河区白渡桥125号博泰新苑', '15010446572', 'tx.png', '15010446572', 'Hmhl303gF', '2', '2021-11-22', 'wiu3xc0wetbd@163.com', '金顶高懿', '100');
INSERT INTO `userinfo` VALUES ('11', '秋文虹', '安徽省白山市友好区安仁路43号爱里舍花园', '15803978533', 'tx.png', '15803978533', 'D2e@$x2(J4v2', '4', '2022-02-07', 'yugq5mo6ukisa@163.com', '逍遥以云', '100');
INSERT INTO `userinfo` VALUES ('12', '栾嘉庆', '甘肃省百色市上甘岭区安澜路3号东新大厦', '15300467073', 'tx.png', '15300467073', 'KZlqGs7UG8', '2', '2021-11-13', '6zgdrf2jllrfl@163.com', '风满问夏', '100');
INSERT INTO `userinfo` VALUES ('13', '明永言', '贵州省白银市新青区宝源路148号溢盈河畔别墅', '13744423879', 'tx.png', '13744423879', '3EEkjSnl9$V', '1', '2022-03-16', '5a5m01u6fsn@163.com', '无击瑜英', '100');
INSERT INTO `userinfo` VALUES ('14', '谯凯歌', '江西省安庆市带岭区宝杨路71号菊园五街坊', '18688038580', 'tx.png', '18688038580', 'pG#7KTGJsANH', '3', '2020-10-16', 'izc4mlwi144pq5@163.com', '芙蓉欣怡', '100');
INSERT INTO `userinfo` VALUES ('15', '刚宏才', '福建省巴中市乌马河区百安路（方泰镇）105号协通公寓', '13261637753', 'tx.png', '13261637753', 'pb^gqSYeq#Ncr3y', '3', '2021-05-02', 'oi250azbtm2ygg6@163.com', '般若夏旋', '100');
INSERT INTO `userinfo` VALUES ('16', '乐安易', '海南省保山市榆次区安边路91号东新大厦', '15277456492', 'tx.png', '15277456492', 'IzB3$hW@', '4', '2020-12-19', 'vxw3dhn6gp@163.com', '先天梦凝', '100');
INSERT INTO `userinfo` VALUES ('17', '笔和怡', '贵州省安顺市南岔区包头南路29号菊园五街坊', '15651312209', 'tx.png', '15651312209', '~+8SyQN(M6H8q', '2', '2022-02-23', '1bdp@163.com', '金顶正诚', '100');
INSERT INTO `userinfo` VALUES ('18', '醋绍钧', '陕西省白山市友好区安业路24号溢盈河畔别墅', '18367264696', 'tx.png', '18367264696', '&q)cvsIpsaC', '4', '2020-02-14', '23fyktu1pxqsqt@163.com', '飞月幻蓉', '100');
INSERT INTO `userinfo` VALUES ('19', '靖良策', '甘肃省白山市友好区百安路（方泰镇）126号东新大厦', '15532467453', 'tx.png', '15532467453', 'UE6rQhTb9o', '3', '2021-05-05', 'c2kiz1b1h@163.com', '销魂玮艺', '100');
INSERT INTO `userinfo` VALUES ('20', '操弘毅', '云南省安阳市金山屯区安化路16号和亭佳苑', '16603574296', 'tx.png', '16603574296', 'A)mPC237afMi', '1', '2022-02-16', '2yk45ap363kbii@163.com', '莲花访蝶', '100');
INSERT INTO `userinfo` VALUES ('21', '郤建德', '山西省白山市友好区安业路138号金色家园', '15673944706', 'tx.png', '15673944706', 'uV#pKDlks+', '1', '2020-08-13', '4pigczo@163.com', '如来英博', '100');
INSERT INTO `userinfo` VALUES ('22', '丙文曜', '山东省保山市榆次区保屯路175号东新大厦', '17230999112', 'tx.png', '17230999112', 'kS+O$TTkS', '3', '2021-06-18', 'c1n@163.com', '太极曼文', '100');
INSERT INTO `userinfo` VALUES ('23', '沙宜然', '贵州省包头市红星区半淞园路34号真新六街坊', '19136772824', 'tx.png', '19136772824', 'XI!5Y4g7Z4', '1', '2022-05-10', 'x2qt6a6x@163.com', '易筋冰珍', '100');
INSERT INTO `userinfo` VALUES ('24', '呀自强', '广东省安阳市金山屯区宝昌路34号东新大厦', '18097376254', 'tx.png', '18097376254', 'NT+_)%mSAwbBh', '4', '2020-12-13', 'xb0b42p1k3rxbv@163.com', '怀心培朵', '100');
INSERT INTO `userinfo` VALUES ('25', '八飞翼', '广东省白银市新青区宝安路58号爱里舍花园', '18458608832', 'tx.png', '18458608832', '~tla)(4%blP', '4', '2020-10-03', 'xgbtbfw6v@163.com', '白骨尔晴雪凝', '100');
INSERT INTO `userinfo` VALUES ('26', '楚成天', '河北省巴彦淖尔市美溪区宝昌路79号耀江花园', '17101687960', 'tx.png', '17101687960', 'LXOEGP*M', '2', '2020-04-08', 'ramfl46j@163.com', '傲寒南珍', '100');
INSERT INTO `userinfo` VALUES ('27', '火德润', '河南省宝鸡市汤旺河区安远路12号博泰新苑', '18991851961', 'tx.png', '18991851961', 'oDvQ!g_HfeuLS*', '3', '2020-08-22', 'g5cidm0hz5@163.com', '神照宏骞', '100');
INSERT INTO `userinfo` VALUES ('28', '狗天禄', '贵州省白山市友好区安远路139号金色家园', '15021621527', 'tx.png', '15021621527', 'bf62MqK5X91Q', '3', '2022-05-01', 'wwg63z6mwwabft@163.com', '无定舒畅', '100');
INSERT INTO `userinfo` VALUES ('29', '应雨星', '四川省安庆市带岭区安德路193号和亭佳苑', '14797532050', 'tx.png', '14797532050', 'z$3epl&Lh%Z$l!L', '1', '2020-04-05', '2dw56rno@163.com', '虚徒睿广', '100');
INSERT INTO `userinfo` VALUES ('30', '续文耀', '安徽省安康市伊春区白城路3号金色家园', '13318224839', 'tx.png', '13318224839', ')g8BcpWaNivh_qA', '3', '2020-06-14', 'tv54hi54@163.com', '玉景荷珠', '100');
INSERT INTO `userinfo` VALUES ('31', '百光誉', '江西省安康市伊春区安波路128号复华城市花园', '13567974478', 'tx.png', '13567974478', '&kP(dv$CZU8', '3', '2022-03-11', 'yz1@163.com', '千手幼凡', '100');
INSERT INTO `userinfo` VALUES ('32', '衣宇航', '山东省鞍山市西林区宝联路136号东新大厦', '14644772549', 'tx.png', '14644772549', '*FjCd35&v', '1', '2020-05-23', 'nis4uu4f33wxr@163.com', '火焰初夏', '100');
INSERT INTO `userinfo` VALUES ('33', '应弘深', '河南省保山市榆次区百官街150号东新大厦', '14537794099', 'tx.png', '14537794099', 'F3bDJTy+V&^DD', '2', '2020-06-11', 's05ljiymh1bf@163.com', '玉霄蕴藉', '100');
INSERT INTO `userinfo` VALUES ('34', '秋成礼', '安徽省包头市红星区爱国路91号爱里舍花园', '14766628726', 'tx.png', '14766628726', 'q44D^#wuigR', '4', '2021-05-20', 'yd6n1sbx@163.com', '天霜南芹', '100');
INSERT INTO `userinfo` VALUES ('35', '秋景同', '甘肃省保山市榆次区宝通路4号阳光翠竹苑', '13837429111', 'tx.png', '13837429111', 'VPvs_YbkL3_Q', '1', '2020-05-13', 'mc4zqjwy@163.com', '洗髓朋龙', '100');
INSERT INTO `userinfo` VALUES ('36', '续睿思', '山东省包头市红星区安德路46号复华城市花园', '15232618118', 'tx.png', '15232618118', 'QhTLlb^S1vMSTYT', '4', '2021-03-31', 'gwsndd@163.com', '北海梓宸', '100');
INSERT INTO `userinfo` VALUES ('37', '桑乐游', '辽宁省安顺市南岔区包头路44号金色家园', '13915148568', 'tx.png', '13915148568', '5$mYS~m8x%9fNX7', '3', '2022-04-23', 'ptcaay2p@163.com', '韦陀胜平', '100');
INSERT INTO `userinfo` VALUES ('38', '笔嘉树', '山东省白城市翠峦区安业路15号东新大厦', '18476559822', 'tx.png', '18476559822', '8K0STTSDC1mK', '3', '2021-02-04', 'gc3q2@163.com', '慈悲文石', '100');
INSERT INTO `userinfo` VALUES ('39', '哀弘文', '福建省保定市乌伊岭区爱国路19号复华城市花园', '13178173954', 'tx.png', '13178173954', 'B$#Wf^92', '2', '2021-09-03', 'q6en3@163.com', '乌龙志高', '100');
INSERT INTO `userinfo` VALUES ('40', '敬浩穰', '广东省白银市新青区宝杨路98号真新六街坊', '13400229320', 'tx.png', '13400229320', 'MQxN+h&&4~', '1', '2021-06-13', 'rypxqs2p@163.com', '玄虚璐莹', '100');
INSERT INTO `userinfo` VALUES ('41', '穆项禹', '黑龙江省蚌埠市五营区宝山路193号东新大厦', '15968683950', 'tx.png', '15968683950', '@7Ccf&7f0_', '3', '2022-04-02', 'l63al55wmvgprk@163.com', '混元爱武', '100');
INSERT INTO `userinfo` VALUES ('42', '啊宏硕', '吉林省蚌埠市五营区板泉路15号菊园五街坊', '13932229325', 'tx.png', '13932229325', '6uRPoR9HQ', '3', '2020-01-30', 'vh53v0m@163.com', '金刚以珊', '100');
INSERT INTO `userinfo` VALUES ('43', '斟兴修', '安徽省安顺市南岔区安波路26号复华城市花园', '13130914298', 'tx.png', '13130914298', '6ZyTwLrBNDU3', '3', '2022-05-11', '0inbf@163.com', '纯阳天亦', '100');
INSERT INTO `userinfo` VALUES ('44', '尉和韵', '河北省包头市红星区白兰路188号金色家园', '14905778358', 'tx.png', '14905778358', 'F^qWmm_aE', '4', '2020-11-11', 'ixh551ujrg@163.com', '拈花秋翠', '100');
INSERT INTO `userinfo` VALUES ('45', '老睿明', '福建省巴彦淖尔市美溪区包头路196号溢盈河畔别墅', '18548366695', 'tx.png', '18548366695', 'vYbJYrZ$IY0', '4', '2022-01-03', '6l2@163.com', '易筋栾诺', '100');
INSERT INTO `userinfo` VALUES ('46', '日彭越', '甘肃省百色市上甘岭区安图路116号阳光翠竹苑', '15747971534', 'tx.png', '15747971534', 'F4Gyl3b~XV57X+', '1', '2021-04-28', '6pqg@163.com', '疯魔诗兰', '100');
INSERT INTO `userinfo` VALUES ('47', '巫泰然', '山西省保定市乌伊岭区百官街68号金色家园', '13689425386', 'tx.png', '13689425386', 'l7s175Jq7clC', '3', '2021-11-29', 'kyzw66oi4@163.com', '天山寅骏', '100');
INSERT INTO `userinfo` VALUES ('48', '郦景辉', '江苏省白城市翠峦区安图路179号和亭佳苑', '15903455989', 'tx.png', '15903455989', 'Su&HLTflJ', '1', '2020-08-07', 'e1jjcj@163.com', '螳螂承恩', '100');
INSERT INTO `userinfo` VALUES ('49', '西兴修', '黑龙江省蚌埠市五营区北艾路140号住友嘉馨名园', '16738017114', 'tx.png', '16738017114', 'B$M8(Yss8*0L1Y6', '4', '2021-07-27', 'cnelm2pgpgp@163.com', '北冥莹雪', '100');
INSERT INTO `userinfo` VALUES ('50', '延浩邈', '台湾省白山市友好区保德路89号菊园五街坊', '17823091802', 'tx.png', '17823091802', 'xq(7VU(~qBD%', '3', '2020-03-23', '0z41@163.com', '太虚盼南', '100');
INSERT INTO `userinfo` VALUES ('51', '东嘉容', '江苏省包头市红星区宝杨路155号协通公寓', '15686327347', 'tx.png', '15686327347', 'JJ3gLWxN2!F#LAr', '4', '2021-11-08', 'iq4r65nmmib@163.com', '江南红娟', '100');
INSERT INTO `userinfo` VALUES ('52', '呀博涛', '陕西省白城市翠峦区安澜路126号耀江花园', '18338065185', 'tx.png', '18338065185', '(_CpbUzS', '1', '2022-03-26', 'wbz1k@163.com', '璃月仙仙', '100');
INSERT INTO `userinfo` VALUES ('53', '死乐邦', '甘肃省保山市榆次区保德路190号阳光翠竹苑', '15555798815', 'tx.png', '15555798815', 'R$xOqeRhjT#&y', '3', '2020-07-23', 'dcg43jqq@163.com', '中原乙卯', '100');
INSERT INTO `userinfo` VALUES ('54', '全英喆', '河南省保定市乌伊岭区安远路171号和亭佳苑', '16527669312', 'tx.png', '16527669312', 'EdJ6vQ_Ne4IU', '2', '2020-02-19', '5fdph6vbslfco@163.com', '魔都学名', '100');
INSERT INTO `userinfo` VALUES ('55', '儇俊风', '湖北省巴彦淖尔市美溪区包头路66号复华城市花园', '15824996139', 'tx.png', '15824996139', '_YIiY^!zsFotSf', '2', '2020-09-21', '66tna0ewiqm0@163.com', '留云喜儿', '100');
INSERT INTO `userinfo` VALUES ('56', '桑安然', '山西省白银市新青区宝林路80号东新大厦', '14653038625', 'tx.png', '14653038625', 'p5s#&Ue2', '1', '2022-01-05', 'pkuuaqfohj01@163.com', '北海奕声', '100');
INSERT INTO `userinfo` VALUES ('57', '湛兴怀', '海南省宝鸡市汤旺河区白城南路175号金色家园', '13077271451', 'tx.png', '13077271451', '#Q*QBd6p~$es73', '2', '2021-11-29', 'bagqe@163.com', '北风香双', '100');
INSERT INTO `userinfo` VALUES ('58', '衣伟博', '吉林省保定市乌伊岭区白城路182号耀江花园', '19810585056', 'tx.png', '19810585056', 'dst+~aiM9Qcen', '4', '2021-06-01', 'wkg4j3q@163.com', '四风驰鸿', '100');
INSERT INTO `userinfo` VALUES ('59', '柴乐池', '江西省安康市伊春区保屯路170号复华城市花园', '17755058676', 'tx.png', '17755058676', '8J5cNH2DbxX!', '4', '2021-11-16', 'wi3udnhfy5x@163.com', '风啸梓豪', '100');
INSERT INTO `userinfo` VALUES ('60', '刚浩邈', '吉林省鞍山市西林区鞍山支路145号住友嘉馨名园', '13717177832', 'tx.png', '13717177832', 'Wz(uiKSb6', '1', '2021-02-26', 'tikz@163.com', '京城孟菊', '100');
INSERT INTO `userinfo` VALUES ('61', '妘子默', '陕西省白山市友好区保德路10号溢盈河畔别墅', '18785994652', 'tx.png', '18785994652', '4wpyFBSpJ', '3', '2020-08-23', '0t1zdqzlbeoi@163.com', '金山飞槐', '100');
INSERT INTO `userinfo` VALUES ('62', '保宏达', '台湾省包头市红星区北艾路59号金色家园', '13448814622', 'tx.png', '13448814622', '&ND)8ywk$pUQ', '4', '2020-03-22', 'kyr0pfkv@163.com', '中原水风', '100');
INSERT INTO `userinfo` VALUES ('63', '勤承安', '陕西省保定市乌伊岭区安仁路172号协通公寓', '15160512180', 'tx.png', '15160512180', 'nzX*15(z6W$Q+V', '4', '2020-03-30', 'yvlh55@163.com', '长安永年', '100');
INSERT INTO `userinfo` VALUES ('64', '见宏逸', '吉林省安阳市金山屯区鞍山支路48号溢盈河畔别墅', '13935791494', 'tx.png', '13935791494', 'nyctbb3TEM&e0', '1', '2020-04-22', 'n52jizaynao@163.com', '墟散兴有', '100');
INSERT INTO `userinfo` VALUES ('65', '妘嘉纳', '江苏省百色市上甘岭区八一路197号协通公寓', '17010153589', 'tx.png', '17010153589', '2Bi(HkVyDI1F@mz', '3', '2020-04-10', 'qjw4s@163.com', '华清曼辞', '100');
INSERT INTO `userinfo` VALUES ('66', '卞晗昱', '海南省白城市翠峦区宝祁路71号爱里舍花园', '18253012131', 'tx.png', '18253012131', 'dLjVr(MH_Z$k', '3', '2021-03-16', 'djbj03ku5u0zf@163.com', '南川冰巧', '100');
INSERT INTO `userinfo` VALUES ('67', '虎光霁', '云南省巴彦淖尔市美溪区安澜路133号住友嘉馨名园', '18009981599', 'tx.png', '18009981599', 'zFOU%uD(KU8', '4', '2021-02-26', 'ceg241ha@163.com', '终幕孝涵', '100');
INSERT INTO `userinfo` VALUES ('68', '竺成文', '云南省巴彦淖尔市美溪区百色路165号复华城市花园', '15799189255', 'tx.png', '15799189255', 'ypPBQsd3z*L9f@', '4', '2021-03-15', 'kxn1g1p@163.com', '平原笑萍', '100');
INSERT INTO `userinfo` VALUES ('69', '延嘉誉', '福建省包头市红星区安化路94号东新大厦', '18721491060', 'tx.png', '18721491060', '+PQ4^Q01(9(E4&k', '4', '2022-04-03', '24mhmudf55u1m@163.com', '法慧伟毅', '100');
INSERT INTO `userinfo` VALUES ('70', '秋飞虎', '江苏省巴彦淖尔市美溪区宝通路178号和亭佳苑', '15936683500', 'tx.png', '15936683500', '@f5sXyimR3I', '4', '2021-01-03', 'u26emc0axrd4ytm@163.com', '碧水婵娟', '100');
INSERT INTO `userinfo` VALUES ('71', '伯阳煦', '吉林省蚌埠市五营区宝源路69号和亭佳苑', '17840639970', 'tx.png', '17840639970', 'c_iwIH8_x#yv(', '1', '2022-04-09', 'e0q@163.com', '百花芮雅', '100');
INSERT INTO `userinfo` VALUES ('72', '水康成', '海南省白山市友好区安福路189号复华城市花园', '18876276416', 'tx.png', '18876276416', 'hq&h4gPwnb^Ig6', '2', '2021-02-17', '42zgwqcx53uf5@163.com', '无冬恬默', '100');
INSERT INTO `userinfo` VALUES ('73', '僧浩穰', '湖北省包头市红星区宝联路79号住友嘉馨名园', '13204462208', 'tx.png', '13204462208', 'J@_CcjZdYHr', '3', '2022-01-21', 'cs1bpma@163.com', '法慧艺馨', '100');
INSERT INTO `userinfo` VALUES ('74', '衣康顺', '浙江省巴彦淖尔市美溪区安边路154号真新六街坊', '15598442012', 'tx.png', '15598442012', 'gL8U8A5gazHEQ5', '3', '2022-04-28', 'g1eo3rz200ltbz@163.com', '北国绮兰', '100');
INSERT INTO `userinfo` VALUES ('75', '别成龙', '山西省安阳市金山屯区安波路166号阳光翠竹苑', '17567612621', 'tx.png', '17567612621', 'U%2b+NyyjgGd(w', '4', '2020-02-11', '0o26@163.com', '珉林醉易', '100');
INSERT INTO `userinfo` VALUES ('76', '延烨熠', '陕西省巴彦淖尔市美溪区板泉路31号耀江花园', '18700766344', 'tx.png', '18700766344', 'eV%J3~IMh', '4', '2021-01-25', 'b144@163.com', '蒙德半雪', '100');
INSERT INTO `userinfo` VALUES ('77', '狮德义', '四川省保山市榆次区宝山路22号博泰新苑', '16554633944', 'tx.png', '16554633944', 'Kg(apZ^N&sM*%', '1', '2020-03-05', 'mq1hcldybv5cits@163.com', '太山恺乐', '100');
INSERT INTO `userinfo` VALUES ('78', '官乐康', '安徽省白银市新青区北艾路111号复华城市花园', '15521169203', 'tx.png', '15521169203', 'QCzb2Jr^YTv', '2', '2020-12-28', 'cc11lkkpbttm41m@163.com', '暴风依童', '100');
INSERT INTO `userinfo` VALUES ('79', '靖斌斌', '青海省包头市红星区白城南路144号阳光翠竹苑', '15101201451', 'tx.png', '15101201451', 'IMrhNpVdzUrJltr', '2', '2021-02-16', 'gpqa5vxph26deyg@163.com', '桃花雨玉', '100');
INSERT INTO `userinfo` VALUES ('80', '狼睿德', '浙江省白银市新青区保屯路99号耀江花园', '15263029272', 'tx.png', '15263029272', 'OabfUh*v@fXxdX', '3', '2021-01-31', 'of5ydd@163.com', '北国安天', '100');
INSERT INTO `userinfo` VALUES ('81', '增坚成', '黑龙江省蚌埠市五营区白玉路29号和亭佳苑', '16551698904', 'tx.png', '16551698904', 'eapb(qVD*xx!', '4', '2020-08-15', 'bglgqzy1gja@163.com', '上清香萱', '100');
INSERT INTO `userinfo` VALUES ('82', '嫖元思', '广东省安康市伊春区爱国路175号菊园五街坊', '18383134672', 'tx.png', '18383134672', 'B1SMY!reRf^', '3', '2021-02-22', 'zds6omluqkhkkm@163.com', '华清锦诗', '100');
INSERT INTO `userinfo` VALUES ('83', '狐明旭', '吉林省保定市乌伊岭区安远路88号耀江花园', '18205818201', 'tx.png', '18205818201', 'O*vzJ&6EaKImcEE', '1', '2020-06-22', '5z3u1d1@163.com', '仲夏殿薇', '100');
INSERT INTO `userinfo` VALUES ('84', '嫖星洲', '陕西省安顺市南岔区安图路197号金色家园', '14613567933', 'tx.png', '14613567933', 'VpGQ4YZSceT', '4', '2021-06-27', 'ad3fg4gsrnzby@163.com', '削月子硕', '100');
INSERT INTO `userinfo` VALUES ('85', '己英光', '吉林省百色市上甘岭区爱国路9号博泰新苑', '17790479247', 'tx.png', '17790479247', 'gl8Q1t(0$', '4', '2021-06-25', '1uphxpb0@163.com', '天际惜珊', '100');
INSERT INTO `userinfo` VALUES ('86', '亢星阑', '河北省白银市新青区爱国路121号耀江花园', '18805443856', 'tx.png', '18805443856', '0702f&MErb(d', '2', '2020-11-05', 'e2of2fqlyqdx6@163.com', '震雷成风', '100');
INSERT INTO `userinfo` VALUES ('87', '老志国', '云南省包头市红星区宝山路105号住友嘉馨名园', '18630011386', 'tx.png', '18630011386', 'k(ulHXPUzWM', '2', '2020-09-15', '2do@163.com', '明冠兴兴', '100');
INSERT INTO `userinfo` VALUES ('88', '滕宏富', '浙江省鞍山市西林区白渡路7号东新大厦', '17843661075', 'tx.png', '17843661075', 'e059oLqrE', '4', '2021-07-10', 'bjvgy4vxm6fve@163.com', '雾都红翔', '100');
INSERT INTO `userinfo` VALUES ('89', '才嘉祥', '湖南省安康市伊春区保屯路77号复华城市花园', '15349156164', 'tx.png', '15349156164', '2n^pD*ifx', '3', '2020-05-24', 'rngo5ectn@163.com', '震雷晨朗', '100');
INSERT INTO `userinfo` VALUES ('90', '您安澜', '甘肃省鞍山市西林区八一路61号金色家园', '15835506603', 'tx.png', '15835506603', 'yd9O9WGC', '2', '2021-11-30', 'duyy2t@163.com', '璃沙其倩', '100');
INSERT INTO `userinfo` VALUES ('91', '姬俊贤', '贵州省鞍山市西林区保德路135号和亭佳苑', '17063865848', 'tx.png', '17063865848', 'u*jsYX@_hd', '1', '2021-04-13', 'eiw6qf4eqr@163.com', '通幽永芬', '100');
INSERT INTO `userinfo` VALUES ('92', '续立人', '河北省安庆市带岭区白水路77号爱里舍花园', '18583207451', 'tx.png', '18583207451', 'b%SSWamsfdejl$', '3', '2020-02-01', '0qgc@163.com', '白云春兰', '100');
INSERT INTO `userinfo` VALUES ('93', '风咏德', '安徽省包头市红星区包头路85号东新大厦', '18648914127', 'tx.png', '18648914127', '~LI%7y80', '4', '2022-01-10', 'vgs0oek@163.com', '东海淑惠', '100');
INSERT INTO `userinfo` VALUES ('94', '栗兴言', '吉林省安顺市南岔区板泉路198号复华城市花园', '15299448498', 'tx.png', '15299448498', 'G!s3i+CzDR', '1', '2020-11-03', 'o3mddg32znbn@163.com', '水月景浩', '100');
INSERT INTO `userinfo` VALUES ('95', '干子平', '吉林省包头市红星区安澜路164号爱里舍花园', '15050985176', 'tx.png', '15050985176', 'cNp0NU1ogDSm', '3', '2022-02-02', 'qaiikpu4@163.com', '奉天秀艳', '100');
INSERT INTO `userinfo` VALUES ('96', '保天泽', '江西省百色市上甘岭区百官街37号住友嘉馨名园', '18648196919', 'tx.png', '18648196919', 'C7p2tJbhsjt&(2', '2', '2020-02-29', '3caicsjze655r@163.com', '北风雪山', '100');
INSERT INTO `userinfo` VALUES ('97', '鸡永怡', '福建省安庆市带岭区爱国路92号金色家园', '17594224425', 'tx3.png', '17594224425', 'pBi9KtWfVA', '4', '2021-06-14', 'z1ajujadfw@163.com', '京城昭阳', '100');
INSERT INTO `userinfo` VALUES ('98', '嵇建木', '吉林省安庆市带岭区宝通路43号耀江花园', '15987919144', 'tx2.png', '15987919144', 'Bjq&17ZHEqu05d', '4', '2021-10-31', 'efkrewx0vakc2dl@163.com', '坠星康裕', '100');
INSERT INTO `userinfo` VALUES ('99', '脱志', '广东省安顺市南岔区白玉路107号爱里舍花园', '17341561635', 'tx3.png', '17', '1122330', '6', '2020-04-02', 'ajbpp5npnj@163.com', '白云昌黎', '100');
INSERT INTO `userinfo` VALUES ('100', '明睿明', '台湾省白山市友好区半淞园路52号耀江花园', '17210676891', 'tx.png', '17210676891', '7o_aSM3KT05Z*$j', '2', '2021-06-05', '6uz03@163.com', '筑阳天才', '100');
INSERT INTO `userinfo` VALUES ('101', '萧雨安', '河南省白山市友好区八一路140号阳光翠竹苑', '15288764295', 'tx.png', '15288764295', 'uj!CMPKeZ', '1', '2021-05-12', 'k4m6hak@163.com', '和安小姐姐', '100');
INSERT INTO `userinfo` VALUES ('102', '何千怡', '四川省安顺市南岔区安义路152号耀江花园', '18772235752', 'tx.png', '18772235752', '3kE1wG0z1SDG', '3', '2021-12-17', 'e2upzf@163.com', '一只痴云呀', '100');
INSERT INTO `userinfo` VALUES ('103', '方芬璇', '青海省巴彦淖尔市美溪区白水路110号金色家园', '15947729346', 'tx.png', '15947729346', 'loDGMlq*', '3', '2020-05-09', 'jxa1e@163.com', '力强小公主', '100');
INSERT INTO `userinfo` VALUES ('104', '蔡雅寒', '福建省蚌埠市五营区包头路40号真新六街坊', '17195569788', 'tx.png', '17195569788', 'ZtIzBmVe', '2', '2021-01-25', 'ogz1d@163.com', '是你的从易呀', '100');
INSERT INTO `userinfo` VALUES ('105', '史云心', '江西省巴彦淖尔市美溪区安波路123号阳光翠竹苑', '13198214895', 'tx.png', '13198214895', 'XIgYYu%tWX', '3', '2020-12-19', 'jzdjapmhl6ocf31@163.com', '雨巷少年怜容', '100');
INSERT INTO `userinfo` VALUES ('106', '梁水芸', '河北省安顺市南岔区百安路（方泰镇）51号和亭佳苑', '15044373047', 'tx.png', '15044373047', 'yYAFB&5+Dw', '1', '2020-08-04', 'qyf2gnyrf6tzi@163.com', '小惜香吖', '100');
INSERT INTO `userinfo` VALUES ('107', '傅未步', '湖南省百色市上甘岭区保屯路29号和亭佳苑', '17315823073', 'tx.png', '17315823073', '64ufBkkP2', '2', '2020-10-05', 'hkc0ave6x4z6@163.com', '一条小彦峰', '100');
INSERT INTO `userinfo` VALUES ('108', '江长英', '江西省保山市榆次区宝联路28号阳光翠竹苑', '18760279150', 'tx.png', '18760279150', 'BlIlbi(pDX2zic', '4', '2022-04-25', 'e3yuedf1q5an@163.com', '江胜大叔', '100');
INSERT INTO `userinfo` VALUES ('109', '秦元冬', '云南省白银市新青区八一路61号博泰新苑', '13768861465', 'tx.png', '13768861465', 'Kf7D~yaNIt2c8r$', '3', '2020-06-29', 'bua@163.com', '曦哲小仙女', '100');
INSERT INTO `userinfo` VALUES ('110', '吴映天', '云南省巴中市乌马河区安汾路48号菊园五街坊', '18334965188', 'tx.png', '18334965188', 'm0%TxR1E%SNv21', '4', '2020-11-25', 'dhsn6e@163.com', '是竹韵吖', '100');
INSERT INTO `userinfo` VALUES ('111', '朱盼香', '黑龙江省白银市新青区安德路40号金色家园', '15294003197', 'tx.png', '15294003197', '4rlFOQhvNbYfSh', '1', '2020-02-16', '61px@163.com', '长霞小哥哥', '100');
INSERT INTO `userinfo` VALUES ('112', '汤秋芸', '湖南省安阳市金山屯区北艾路11号东新大厦', '19862545141', 'tx.png', '19862545141', 'M25KMHvLtaoy*', '1', '2020-01-09', 'aidhvtvnm@163.com', '和光小哥哥', '100');
INSERT INTO `userinfo` VALUES ('113', '薛静丹', '河南省包头市红星区半淞园路105号和亭佳苑', '18237504030', 'tx.png', '18237504030', 'E0JsB$58%q~LV', '2', '2021-05-05', 'vd3xlcm5u@163.com', '忻畅公子', '100');
INSERT INTO `userinfo` VALUES ('114', '吴梓美', '甘肃省包头市红星区百花街18号协通公寓', '13215577649', 'tx.png', '13215577649', 'Oz)xmsBIbE', '1', '2022-02-22', '6n0rolfyv@163.com', '新良超级甜', '100');
INSERT INTO `userinfo` VALUES ('115', '杜贞芳', '辽宁省包头市红星区北艾路194号住友嘉馨名园', '18284849792', 'tx.png', '18284849792', 'yCZl29w3t#bf', '2', '2020-03-15', 'jvpkpx4fmo6@163.com', '梦琪来了', '100');
INSERT INTO `userinfo` VALUES ('116', '叶安蕾', '浙江省安康市伊春区北艾路46号阳光翠竹苑', '17405161133', 'tx.png', '17405161133', '@lpBEHF@l', '4', '2020-05-14', '4vtoqizat2@163.com', '玉涵baby', '100');
INSERT INTO `userinfo` VALUES ('117', '龚友蕊', '吉林省巴中市乌马河区白玉路19号真新六街坊', '15127344088', 'tx.png', '15127344088', '5DEd)v1q', '3', '2021-03-11', 'grups0ko3zyf6@163.com', '启峰丶小可爱', '100');
INSERT INTO `userinfo` VALUES ('118', '叶春雨', '江苏省巴中市乌马河区安波路65号复华城市花园', '15996193429', 'tx.png', '15996193429', 'hT%Q+uEe0n', '3', '2020-09-30', 'sivfhtgrmpf@163.com', '寻阳来了', '100');
INSERT INTO `userinfo` VALUES ('119', '李淳静', '江西省百色市上甘岭区宝通路183号阳光翠竹苑', '17637964554', 'tx.png', '17637964554', 'G$$63bS_uT5#', '1', '2020-02-17', '6136ubo0i02hlmc@163.com', '一吃就胖小永亮', '100');
INSERT INTO `userinfo` VALUES ('120', '邱雪艳', '陕西省安康市伊春区宝林路59号菊园五街坊', '16537543015', 'tx.png', '16537543015', '(rUaLXe4qu3pt', '2', '2021-06-26', 'c0gpt04ad2ljvwe@163.com', '猫巷少女含香', '100');
INSERT INTO `userinfo` VALUES ('121', '郝婧芸', '浙江省蚌埠市五营区安化路47号真新六街坊', '13978894877', 'tx.png', '13978894877', '4~Wp$UJvk%84da', '1', '2020-04-04', 'ku0p@163.com', '努力啊大统赫', '100');
INSERT INTO `userinfo` VALUES ('122', '石尔槐', '广东省宝鸡市汤旺河区鞍山路153号耀江花园', '13825967501', 'tx.png', '13825967501', 'RXJxJ97tPJR&m7p', '1', '2021-08-18', '4fwyfmzno@163.com', '晓灵小郎君', '100');
INSERT INTO `userinfo` VALUES ('123', '余竹韵', '江西省白城市翠峦区百色路111号东新大厦', '18930033971', 'tx.png', '18930033971', 'V7OLBRu3', '3', '2021-10-26', '2qgosjwlg332y@163.com', '书生尔竹', '100');
INSERT INTO `userinfo` VALUES ('124', '董芬芬', '河北省安康市伊春区白水路90号博泰新苑', '15359944431', 'tx.png', '15359944431', 'U9+zTqq3hZ3H2o', '3', '2022-05-08', 'eftvx3ysuofv@163.com', '沛山酱大魔王', '100');
INSERT INTO `userinfo` VALUES ('125', '龙初月', '四川省百色市上甘岭区八一路108号阳光翠竹苑', '18284272898', 'tx.png', '18284272898', 'L!%omB#bDsgl', '2', '2021-11-17', 'xnnftwbq0@163.com', '凌香小郎君', '100');
INSERT INTO `userinfo` VALUES ('126', '金白筠', '河南省宝鸡市汤旺河区安福路112号协通公寓', '13563138375', 'tx.png', '13563138375', 'xCVUpmtHYg$qZ', '3', '2021-10-01', 'qibz0@163.com', '寻绿小娘子', '100');
INSERT INTO `userinfo` VALUES ('127', '宋白曼', '山东省保山市榆次区鞍山路36号阳光翠竹苑', '18061612222', 'tx.png', '18061612222', '$h$NjWU*X4', '4', '2022-04-08', 'is2uiusu@163.com', '是思晨吖', '100');
INSERT INTO `userinfo` VALUES ('128', '周寒天', '安徽省鞍山市西林区宝山路44号耀江花园', '19189593968', 'tx.png', '19189593968', 'd~B@ow2Ow&~l$Z1', '1', '2021-10-20', 'n6u@163.com', '铭晨少女', '100');
INSERT INTO `userinfo` VALUES ('129', '黄梦竹', '贵州省蚌埠市五营区安仁路84号金色家园', '15871339441', 'tx.png', '15871339441', 'H$92NTb*XM&', '2', '2020-04-09', '0ex@163.com', '琳芳mio', '100');
INSERT INTO `userinfo` VALUES ('130', '罗夜春', '广东省蚌埠市五营区白城南路176号耀江花园', '13817188993', 'tx.png', '13817188993', '^p4CmR7cRtMKgSE', '2', '2021-01-26', 'cj2yi4y64@163.com', '晴美可爱吗', '100');
INSERT INTO `userinfo` VALUES ('131', '蔡绮琴', '广东省白山市友好区安龙路40号耀江花园', '19836068713', 'tx.png', '19836068713', 'W~hoxpDRFl', '2', '2020-01-31', 'yjgwglxkc1jp4@163.com', '鸿畅酱吖', '100');
INSERT INTO `userinfo` VALUES ('132', '江宜春', '贵州省蚌埠市五营区百安路（方泰镇）65号菊园五街坊', '15201914882', 'tx.png', '15201914882', 'BqWoph2ye69^fh', '1', '2020-06-19', '1eh@163.com', '山亦少爷', '100');
INSERT INTO `userinfo` VALUES ('133', '谢隽美', '江苏省白山市友好区宝林路123号博泰新苑', '13601674205', 'tx.png', '13601674205', 'KyAB#fLHLGma!', '1', '2020-01-21', 'cnta3f6g4x@163.com', '是你的丹翠呀', '100');
INSERT INTO `userinfo` VALUES ('134', '江暖姝', '吉林省安康市伊春区白渡路175号复华城市花园', '13172066488', 'tx.png', '13172066488', 'MtlxOe15JM~n&E1', '3', '2022-03-25', 'vdvl11k2xzikqc2@163.com', '努力啊大淳雅', '100');
INSERT INTO `userinfo` VALUES ('135', '谭宛畅', '河南省保山市榆次区包头路10号菊园五街坊', '15010787660', 'tx.png', '15010787660', 'XpaqK&qWK', '1', '2020-01-26', 'tm04ew@163.com', '小雅柔吖', '100');
INSERT INTO `userinfo` VALUES ('136', '周天巧', '青海省白银市新青区白渡路164号耀江花园', '18646985166', 'tx.png', '18646985166', 'k&Ix+Pgyj1', '1', '2020-01-05', '3rgxn@163.com', '一只炎昊呀', '100');
INSERT INTO `userinfo` VALUES ('137', '宋春芳', '安徽省巴中市乌马河区百花街31号博泰新苑', '13952441726', 'tx.png', '13952441726', 'amCYtJl*d', '4', '2021-04-23', 'x6o@163.com', '邻家令雪', '100');
INSERT INTO `userinfo` VALUES ('138', '刘会雯', '四川省安庆市带岭区白渡桥89号溢盈河畔别墅', '14921527358', 'tx.png', '14921527358', 'vVpvZR1C0f', '4', '2022-03-30', 'lnxvedhqjrz1cd5@163.com', '一只智超呀', '100');
INSERT INTO `userinfo` VALUES ('139', '曹迎梦', '青海省巴中市乌马河区宝林路152号耀江花园', '13584597671', 'tx.png', '13584597671', '^i1yfG8+BRl', '1', '2021-11-23', '4n1@163.com', '昊宇mm丶', '100');
INSERT INTO `userinfo` VALUES ('140', '石韦柔', '河南省保定市乌伊岭区安福路48号真新六街坊', '15961448887', 'tx.png', '15961448887', 'UTl5YRIvQ!Ywrj1', '3', '2021-04-12', '0264@163.com', '邻家福跃', '100');
INSERT INTO `userinfo` VALUES ('141', '邓柔煦', '陕西省蚌埠市五营区安化路103号住友嘉馨名园', '18644923417', 'tx.png', '18644923417', 'ChGC@VIRREY6O', '3', '2021-05-08', '1ud41az1levf@163.com', '秀雅来了', '100');
INSERT INTO `userinfo` VALUES ('142', '戴若彤', '江西省安阳市金山屯区宝通路0号协通公寓', '13083049554', 'tx.png', '13083049554', 'QKRSzkfklqw', '2', '2021-08-16', 'pito1focod@163.com', '天帅姑娘', '100');
INSERT INTO `userinfo` VALUES ('143', '张代丝', '四川省保定市乌伊岭区保屯路174号耀江花园', '17791238133', 'tx.png', '17791238133', 'iGRi~bLj!d', '3', '2020-05-10', 'mdjflgpo03jp@163.com', '努力啊大树鹤', '100');
INSERT INTO `userinfo` VALUES ('144', '邹智敏', '甘肃省包头市红星区宝源路140号协通公寓', '15821462268', 'tx.png', '15821462268', 's^I7us_dptxm3%4', '2', '2020-02-17', 'soqa@163.com', '是你的迁迁呀', '100');
INSERT INTO `userinfo` VALUES ('145', '谢谷蓝', '湖南省包头市红星区安亭路189号真新六街坊', '15910127984', 'tx.png', '15910127984', 'pwPUtaY^J', '1', '2021-12-09', 'y5k2k4srla0qvmq@163.com', '春竹三岁啦', '100');
INSERT INTO `userinfo` VALUES ('146', '董雁枫', '湖北省宝鸡市汤旺河区宝安公路40号阳光翠竹苑', '19155972409', 'tx.png', '19155972409', 'eD@hKk#C~', '4', '2020-11-23', 'syxuqew@163.com', '青容小姐姐', '100');
INSERT INTO `userinfo` VALUES ('147', '韩佳思', '河南省安庆市带岭区北艾路129号东新大厦', '13836239289', 'tx.png', '13836239289', 'oe44Jl5LreM*', '4', '2021-08-05', 'qibz0@163.com', '盼山酱吖', '100');
INSERT INTO `userinfo` VALUES ('148', '余贞芳', '青海省安康市伊春区白城南路195号博泰新苑', '17086757964', 'tx.png', '17086757964', 'lfDaU2pN2k', '2', '2020-03-18', 'mwfzo@163.com', '一条小高邈', '100');
INSERT INTO `userinfo` VALUES ('149', '方慕梅', '江苏省宝鸡市汤旺河区白城南路110号爱里舍花园', '17189551387', 'tx.png', '17189551387', 'abVT+zI(3dCHPx', '4', '2021-02-10', 'nvncxforzmt01o@163.com', '是歌飞吖', '100');
INSERT INTO `userinfo` VALUES ('150', '赵访云', '台湾省安阳市金山屯区宝杨路24号博泰新苑', '14585889636', 'tx.png', '14585889636', 't!6%wyL~SILi', '4', '2020-07-30', 'jh4606xznpt@163.com', '宛亦公子', '100');
INSERT INTO `userinfo` VALUES ('151', '孟语晨', '江西省白山市友好区安亭路88号住友嘉馨名园', '17076268047', 'tx.png', '17076268047', 'hOBdz_JLccCF', '3', '2021-05-12', 'dpuz0c@163.com', '嘉懿Sama', '100');
INSERT INTO `userinfo` VALUES ('152', '石鹤梦', '福建省巴中市乌马河区宝林路31号协通公寓', '18738837363', 'tx.png', '18738837363', 'FxQ0UR!H%', '2', '2021-04-06', 'uecswl4b5@163.com', '名哲桑', '100');
INSERT INTO `userinfo` VALUES ('153', '万秀如', '河北省白山市友好区安龙路16号博泰新苑', '13078027028', 'tx.png', '13078027028', '~+Q8m@IV&#C', '2', '2021-04-12', 'awjhsco@163.com', '蓬莱山永年', '100');
INSERT INTO `userinfo` VALUES ('154', '王小雨', '安徽省白城市翠峦区白城南路196号东新大厦', '15360834534', 'tx.png', '15360834534', '2_N@LYURy!G', '1', '2021-10-27', '0v3w3a@163.com', '犬走元槐', '100');
INSERT INTO `userinfo` VALUES ('155', '徐盼香', '四川省白山市友好区巴林路41号复华城市花园', '18407466322', 'tx.png', '18407466322', 'Gj2nMp_UF$', '3', '2021-01-08', 'd2kbet0ym1@163.com', '天神院绮风', '100');
INSERT INTO `userinfo` VALUES ('156', '唐恬雅', '湖北省包头市红星区保屯路51号博泰新苑', '17634658350', 'tx.png', '17634658350', 'uovg0j(DKy3', '3', '2022-03-12', 'hwhu25znm@163.com', '風見静卉', '100');
INSERT INTO `userinfo` VALUES ('157', '杜夏蓉', '甘肃省百色市上甘岭区白兰路118号金色家园', '13000413316', 'tx.png', '13000413316', 'nyRm_SNV#E', '1', '2020-09-23', 'kbsmfq6os4ib5@163.com', '坂田虹星', '100');
INSERT INTO `userinfo` VALUES ('158', '赵孟夏', '河南省百色市上甘岭区安汾路53号金色家园', '17787971001', 'tx.png', '17787971001', '*#Z3HRmB2ADcoJ', '3', '2021-02-23', 'pta0yg54nc@163.com', '蓬莱山梓欣', '100');
INSERT INTO `userinfo` VALUES ('159', '任丽泽', '江苏省蚌埠市五营区安顺路93号真新六街坊', '17111224879', 'tx.png', '17111224879', 'j9%4I!3&', '4', '2021-08-29', 'zagz54pu0z1zv5@163.com', '子楠Sama', '100');
INSERT INTO `userinfo` VALUES ('160', '彭玉萍', '山东省蚌埠市五营区宝安公路117号爱里舍花园', '16522083137', 'tx.png', '16522083137', 'ZPd&JmlpfFOA0Ic', '1', '2020-09-06', '1k03@163.com', '幽花涵畅', '100');
INSERT INTO `userinfo` VALUES ('161', '崔许弋', '江苏省巴彦淖尔市美溪区鞍山支路185号真新六街坊', '18945173242', 'tx.png', '18945173242', 'J^6~SLB^ry18f', '1', '2021-10-17', 'fxvei5@163.com', '藤原雅丹', '100');
INSERT INTO `userinfo` VALUES ('162', '钱朗然', '江西省百色市上甘岭区宝联路17号耀江花园', '13167474167', 'tx.png', '13167474167', '27RQADD)3weLt', '2', '2021-09-03', 'vg2nvprnq0vuazn@163.com', '矢泽盼枫', '100');
INSERT INTO `userinfo` VALUES ('163', '易奥雅', '贵州省安庆市带岭区宝山路82号耀江花园', '15274897192', 'tx.png', '15274897192', 'eXFaVw0W5wG', '4', '2022-04-18', '0v1l1@163.com', '冬马俊贤', '100');
INSERT INTO `userinfo` VALUES ('164', '汪博雅', '山东省安顺市南岔区宝山路161号协通公寓', '13407145632', 'tx.png', '13407145632', 'j)ZAbiFr', '4', '2021-03-02', 'mvdr2wclbq6@163.com', '风见阳曜', '100');
INSERT INTO `userinfo` VALUES ('165', '孔冰彦', '江苏省安阳市金山屯区宝通路183号金色家园', '17067236320', 'tx.png', '17067236320', 'H*geuwt4v%5Oj', '1', '2021-12-15', '0o5mgjdstavf2pz@163.com', '骞泽殿下', '100');
INSERT INTO `userinfo` VALUES ('166', '康访烟', '吉林省白山市友好区宝昌路71号住友嘉馨名园', '16559493868', 'tx.png', '16559493868', 'R(lQY3S+XIxzy', '1', '2020-08-21', '2qotea0hjd@163.com', '魂魄佩杉', '100');
INSERT INTO `userinfo` VALUES ('167', '文莉娜', '四川省巴彦淖尔市美溪区安仁路22号溢盈河畔别墅', '18439507774', 'tx.png', '18439507774', 'al+5qp5S^l%pJ7', '2', '2022-04-12', '2kezeuc56go@163.com', '天神院嘉许', '100');
INSERT INTO `userinfo` VALUES ('168', '石从雪', '福建省巴中市乌马河区包头南路98号耀江花园', '18428712797', 'tx.png', '18428712797', 'WJF046r8', '1', '2020-03-10', 'xe1hve4l@163.com', '水桥天籁', '100');
INSERT INTO `userinfo` VALUES ('169', '任俊英', '台湾省安阳市金山屯区白城南路103号菊园五街坊', '14601919609', 'tx.png', '14601919609', 'G!yQS9BkIY+#X(', '1', '2020-09-18', 'siibl64v@163.com', '泄矢正青', '100');
INSERT INTO `userinfo` VALUES ('170', '唐傲芙', '辽宁省百色市上甘岭区百安路（方泰镇）39号协通公寓', '15892444902', 'tx.png', '15892444902', 'Gm108&nzk3', '2', '2022-02-15', '4rqrcn10@163.com', '凤凰院华美', '100');
INSERT INTO `userinfo` VALUES ('171', '彭元风', '贵州省安庆市带岭区保屯路57号博泰新苑', '18578253310', 'tx.png', '18578253310', '8f+6a#8sjE^@', '1', '2020-11-03', 'yccwhioirr0@163.com', '風見盼波', '100');
INSERT INTO `userinfo` VALUES ('172', '陆夏初', '甘肃省安康市伊春区白渡路181号住友嘉馨名园', '13320137411', 'tx.png', '13320137411', '0iXMNv(&48', '2', '2022-03-06', 'zlob2l25p@163.com', '七濑香莲', '100');
INSERT INTO `userinfo` VALUES ('173', '蔡司辰', '四川省白银市新青区安业路141号耀江花园', '14511577480', 'tx.png', '14511577480', '7*K3B0LCVfg7Po', '1', '2022-01-30', 'moh5zv@163.com', '小野寺之薇', '100');
INSERT INTO `userinfo` VALUES ('174', '龚米莱', '海南省宝鸡市汤旺河区保屯路177号溢盈河畔别墅', '18094915075', 'tx.png', '18094915075', 'bGBIaJ^@yTnCc4C', '4', '2022-04-23', 'bhhfl@163.com', '矢泽书雪', '100');
INSERT INTO `userinfo` VALUES ('175', '卢娴静', '陕西省安阳市金山屯区安边路6号溢盈河畔别墅', '17004541689', 'tx.png', '17004541689', '#*3c8%g*Qgsb', '3', '2020-10-16', 'lm2aaudo@163.com', '暗月寺半芹', '100');
INSERT INTO `userinfo` VALUES ('176', '马寻真', '四川省百色市上甘岭区宝源路5号菊园五街坊', '19967297389', 'tx.png', '19967297389', 'KX)_n2oyD!twl$', '1', '2020-09-27', '23egbqgc@163.com', '星熊思琳', '100');
INSERT INTO `userinfo` VALUES ('177', '贾溪儿', '四川省安阳市金山屯区白渡桥107号耀江花园', '17768924243', 'tx.png', '17768924243', 'frDg(5t&%Gv', '2', '2020-06-12', '2fqxuojpzapkslo@163.com', '云居雪瑞', '100');
INSERT INTO `userinfo` VALUES ('178', '石湛恩', '安徽省保定市乌伊岭区包头南路199号溢盈河畔别墅', '18261768859', 'tx.png', '18261768859', 'zoA*4EsST0', '4', '2021-12-26', 'cw6l2llz6tk1tt@163.com', '西行寺凌雪', '100');
INSERT INTO `userinfo` VALUES ('179', '袁欣彩', '黑龙江省白城市翠峦区安边路0号和亭佳苑', '13014606579', 'tx.png', '13014606579', 'oyD4H&ZOy3', '3', '2020-03-06', '1fjjf5vyoxr1@163.com', '幽香辛丑', '100');
INSERT INTO `userinfo` VALUES ('180', '苏瑜敏', '浙江省保山市榆次区巴林路171号金色家园', '15159388846', 'tx.png', '15159388846', 'o+h3CUeC#P0CwV!', '3', '2021-04-24', '6ck@163.com', '冬马以冬', '100');
INSERT INTO `userinfo` VALUES ('181', '戴雪柳', '海南省百色市上甘岭区宝山路159号爱里舍花园', '13649903901', 'tx.png', '13649903901', 'Ss$6qrkDU5', '3', '2020-04-12', 'wk61gxcr0y@163.com', '五河俊捷', '100');
INSERT INTO `userinfo` VALUES ('182', '王雅可', '吉林省保山市榆次区安澜路115号住友嘉馨名园', '15912294312', 'tx.png', '15912294312', '2IfEbc$nbxe_', '2', '2020-09-29', 'bdp3gjuejbi5@163.com', '云居传禄', '100');
INSERT INTO `userinfo` VALUES ('183', '罗继红', '河南省巴彦淖尔市美溪区保定路79号复华城市花园', '13117217244', 'tx.png', '13117217244', '2_t1aCi7Nc%vZ$9', '1', '2021-06-08', '4sulrj03@163.com', '御阪浩淼', '100');
INSERT INTO `userinfo` VALUES ('184', '卢璎玑', '山西省蚌埠市五营区保定路119号博泰新苑', '17271756605', 'tx.png', '17271756605', 'qz0RPH5pMLMvav', '1', '2021-05-19', 'zeju4u@163.com', '玉刚子', '100');
INSERT INTO `userinfo` VALUES ('185', '孙虹英', '江苏省白城市翠峦区安化路72号住友嘉馨名园', '17380257095', 'tx.png', '17380257095', 'wvi%_b6_5XP', '3', '2022-03-29', 'gzlh4wki@163.com', '泄矢书亮', '100');
INSERT INTO `userinfo` VALUES ('186', '吕银柳', '浙江省安顺市南岔区保屯路90号东新大厦', '14908237082', 'tx.png', '14908237082', 'EGj3g%UW_k%nA~', '3', '2020-04-17', 'uzl5aqnls3@163.com', '五河海逸', '100');
INSERT INTO `userinfo` VALUES ('187', '赖秋柏', '台湾省安顺市南岔区白水路156号阳光翠竹苑', '16511041810', 'tx.png', '16511041810', 'gvqn651&D', '1', '2020-04-22', 'dyaq41zklus@163.com', '七濑蕊珠', '100');
INSERT INTO `userinfo` VALUES ('188', '谢连英', '黑龙江省百色市上甘岭区宝安公路68号菊园五街坊', '17659142635', 'tx.png', '17659142635', 'NNHb1d*~_9F1', '1', '2020-05-29', 'awci4yq@163.com', '八坂暖暖', '100');
INSERT INTO `userinfo` VALUES ('189', '邓芮欢', '甘肃省巴彦淖尔市美溪区鞍山路199号菊园五街坊', '18508497147', 'tx.png', '18508497147', 'Xd5_9y@)uo', '4', '2021-09-20', 'fhaoor6@163.com', '阳晖君', '100');
INSERT INTO `userinfo` VALUES ('190', '曹芷荷', '辽宁省鞍山市西林区北艾路146号菊园五街坊', '19803693556', 'tx.png', '19803693556', 'l8f9+xnU9M@wH2', '3', '2022-02-15', 'imy3ro@163.com', '西行寺汀兰', '100');
INSERT INTO `userinfo` VALUES ('191', '丁迷伤', '甘肃省百色市上甘岭区鞍山支路45号阳光翠竹苑', '15363754154', 'tx.png', '15363754154', '_ns)*~6U', '3', '2020-07-29', 'ijx4ba6lpz1jd46@163.com', '犬走永福', '100');
INSERT INTO `userinfo` VALUES ('192', '武米兰', '陕西省安顺市南岔区安国路152号爱里舍花园', '17648068671', 'tx.png', '17648068671', 'PF5uNTt0huTX#)', '4', '2020-01-19', '6cnli5hqucvmx6@163.com', '香风曼凡', '100');
INSERT INTO `userinfo` VALUES ('193', '贺芹悦', '山西省巴彦淖尔市美溪区安边路40号阳光翠竹苑', '18021671977', 'tx.png', '18021671977', '*Y$T&Au1E*F^zg', '2', '2022-01-27', '6p2r@163.com', '魂魄绮晴', '100');
INSERT INTO `userinfo` VALUES ('194', '方燕楠', '贵州省保定市乌伊岭区安德路180号爱里舍花园', '16618607789', 'tx.png', '16618607789', 'DGNLNa8Rej&', '2', '2021-07-30', 'vxq@163.com', '子宁酱', '100');
INSERT INTO `userinfo` VALUES ('195', '孙恬美', '福建省白山市友好区百安路（方泰镇）135号协通公寓', '18924768767', 'tx.png', '18924768767', 'hTnDycv^_1mH(', '4', '2020-03-08', 'aluqcom@163.com', '香风代珊', '100');
INSERT INTO `userinfo` VALUES ('196', '黄龙梅', '云南省宝鸡市汤旺河区百色路97号阳光翠竹苑', '17336097756', 'tx.png', '17336097756', 'dDTiblZ*Kb5J4', '2', '2021-03-13', 'ipy0ddx@163.com', '风见芬芬', '100');
INSERT INTO `userinfo` VALUES ('197', '汪海燕', '河南省宝鸡市汤旺河区宝安公路20号博泰新苑', '16506628132', 'tx.png', '16506628132', 'V4$yZ!Kx+R@$w', '2', '2021-02-17', 'bgj6mt@163.com', '宫古俊能', '100');
INSERT INTO `userinfo` VALUES ('198', '康幻珊', '安徽省巴彦淖尔市美溪区安仁路47号东新大厦', '17550671565', 'tx.png', '17550671565', 'KqW+^dR9#Y_$', '4', '2020-04-21', 'pv20hm4iisc@163.com', '星熊青寒', '100');
INSERT INTO `userinfo` VALUES ('199', '贺水香', '青海省蚌埠市五营区宝昌路62号和亭佳苑', '13347976027', 'tx.png', '13347976027', 'uv5MJA54KLTrN', '2', '2022-05-06', '3kyngwl@163.com', '东风谷如旋', '100');
INSERT INTO `userinfo` VALUES ('200', '龙冬莲', '吉林省百色市上甘岭区宝通路130号金色家园', '13473987018', 'tx.png', '13473987018', 'r17otBp%U6', '4', '2022-03-23', 'ihk2@163.com', '山亦氏', '100');
INSERT INTO `userinfo` VALUES ('201', null, null, '13988888888', 'tx.png', '13988888888', '1234567', '1', '2022-05-25', 'emi@qq.com', '艾米', '100');
INSERT INTO `userinfo` VALUES ('202', null, null, '12312345678', 'tx.png', '12312345678', '0000000', '1', '2022-05-25', '123@gmail.com', '王玉凤', '100');
INSERT INTO `userinfo` VALUES ('203', '张三', '重庆渝北区', '17823811291', 'tx1.png', '2', '1234567', '2', '2022-05-25', '123@qq.com', '法外狂徒', '100');
INSERT INTO `userinfo` VALUES ('206', '李四', '重庆沙坪坝', '17823811292', 'tx.png', '1', '1472583', '1', '2022-05-27', '1234@qq.com', '制作者', '100');
INSERT INTO `userinfo` VALUES ('207', null, null, '17823541245', null, '17823541245', '1234567', '1', '2022-06-07', '1234546@qq.com', '阿铁打', '100');
INSERT INTO `userinfo` VALUES ('208', null, null, '18165456156', null, '18165456156', '1234567', '1', '2022-06-20', '12315465@qq.com', '王励', '100');
INSERT INTO `userinfo` VALUES ('209', '王小励', '重庆沙坪坝', '17823811297', 'tx.png', '17823811297', '12345678', '1', '2022-06-24', '1213@qq.com', '刀哥', '100');
INSERT INTO `userinfo` VALUES ('210', '王丽丽', '重庆沙坪坝', '12345678999', 'tx1.png', '12345678999', '1234567', '1', '2022-06-24', '112233@163.com', '嘻嘻嘻', '100');
INSERT INTO `userinfo` VALUES ('211', '订单', '重庆沙坪坝', '14725836900', 'tx1.png', '14725836900', '1234567', '1', '2022-06-24', '1231@163.com', '看看', '100');
...
CREATE TABLE `vip` (
  ...
  `v_levelup` int(11) DEFAULT NULL,
  `v_discount` decimal(8,2) DEFAULT NULL,
...
INSERT INTO `vip` VALUES ('8', '20000', '0.88');
INSERT INTO `vip` VALUES ('9', '50000', '0.85');
INSERT INTO `vip` VALUES ('10', '100000', '0.80');
INSERT INTO `vip` VALUES ('11', '188888', '0.70');
INSERT INTO `vip` VALUES ('12', '0', '1.00');
