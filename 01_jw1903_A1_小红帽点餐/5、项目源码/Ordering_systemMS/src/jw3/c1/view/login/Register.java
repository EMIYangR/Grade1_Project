...
public class Register extends JFrame {
    ...
    private void button1MouseClicked(MouseEvent e) {
        ...
        if (label6.isVisible()||label7.isVisible()||label8.isVisible()||label9.isVisible()||label10.isVisible()){
            ...
            Boolean pd=UserinfoController.zhec(textField2.getText(),textField2.getText(),passwordField2.getText(),dtf.format(localDate),textField3.getText(),textField1.getText());
...
//            label7.setVisible(false);
    ...
    public void ncpd(){
       ...
       String a=textField1.getText();
        int b= UserinfoController.ncpd(a);
        switch (b){
            case 1:
                label10.setVisible(false);
                break;
