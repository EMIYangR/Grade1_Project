 ...
 * @author Brainrain
 */
public class Become_a_merchant extends JFrame {
    public Become_a_merchant() {
        initComponents();
    ...
    private void button1MouseClicked(MouseEvent e) {
        ...
        if(MertypeController.cx3(lx)){
            ...
            dispose();
                ...
                JOptionPane.showMessageDialog(null,"商家创建失败");
            }
    }
    ...
    private void initComponents() {
        ...
        label4.setIcon(Imagesinks.png(url,100,100));
        label4.setText("");
        Map<String, String> map = scwj.getFilesDatas("images/mer/");
