 ...
 * @author Brainrain
 */
public class Edit_the_material extends JFrame {
    public Edit_the_material() {
        initComponents();
        setVisible(true);
        setSize(800,700);
        setResizable(false);
    ...
    private void textField2KeyReleased(KeyEvent e) {
        ...
        if (a.length()>0){
            ...
            if (sjh1.length==11){
                if (!textField2.getText().equals(dh)){
                int b= UserinfoController.sjhpd(a);
                switch (b){
                    case 1:
                        label7.setVisible(false);
                        break;
...
//            label7.setVisible(false);
    ...
    private void button3MouseClicked(MouseEvent e) {
        scwj.eventOnImport(new JButton());
    }
    ...
    private void initComponents() {
        ...
        button3.setBounds(610, 90, 95, 40);
        ...
        Map<String, String> map = scwj.getFilesDatas("images/tx/");
